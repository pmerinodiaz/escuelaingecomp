...
<META NAME="description" CONTENT="P�gina en donde se muestra el formulario para que una persona pueda agregar una pregunta frecuente.">
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    <TD WIDTH="154" HEIGHT="610" ROWSPAN="3" VALIGN="TOP" BACKGROUND="../librerias/bgmenu.gif">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR> 
					<TD WIDTH="76%" CLASS="ubicacion">Ubicaci&oacute;n: <A HREF="../home/index.php" TITLE="Ver Home">Home</A> / <A HREF="index.php?pagina=1" TITLE="Ver Preguntas Frecuentes">Preguntas Frecuentes</A> / Agregar</TD>
					<TD ROWSPAN="2" WIDTH="24%" VALIGN="TOP"><IMG SRC="activos/bgfaq.jpg" WIDTH="110" HEIGHT="45"></TD>
				</TR>
				<TR> 
					<TD WIDTH="76%" CLASS="titulo">Agregar Pregunta Frecuente</TD>
				</TR>
				<TR> 
  ...
  <TR>
    <TD WIDTH="6" HEIGHT="100" VALIGN="TOP"></TD>
    <TD WIDTH="460" HEIGHT="100" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR> 
					<TD WIDTH="15%" ALIGN="LEFT"><IMG SRC="activos/notebook.jpg" WIDTH="65" HEIGHT="95"></TD>
					<TD WIDTH="85%" VALIGN="TOP" CLASS="contenido">
						<P>A trav&eacute;s de esta opci&oacute;n podr&aacute;s efectuar tu pregunta. Ten en cuenta que la respuesta a tu pregunta ser&aacute; publicada en esta secci&oacute;n, por lo que ser&aacute; un verdadero y valioso aporte a este Sitio Web</P>
  ...
  <TR>
    <TD WIDTH="6" HEIGHT="450" VALIGN="TOP"></TD>
    <TD WIDTH="460" HEIGHT="450" COLSPAN="4" VALIGN="TOP">
				...
				<TR> 
                    ...
                    <SPAN CLASS="contenido"> <FONT COLOR="#CC0000">*</FONT></SPAN></TD>
								...
								<TR> 
									...
									<TD WIDTH="70%"><INPUT NAME="asunto" TYPE="text" CLASS="formtextfield" TABINDEX="1" MAXLENGTH="100" TITLE="Asunto de la pregunta">
                    <SPAN CLASS="contenido"> <FONT COLOR="#CC0000">*</FONT></SPAN></TD>
								</TR>
								<TR> 
								...
								<TR> 
									<TD COLSPAN="2" ALIGN="CENTER"><TEXTAREA NAME="texto" CLASS="formtextarea" ROWS="8" TABINDEX="1" TITLE="Texto de la pregunta"></TEXTAREA>
                    <SPAN CLASS="contenido"> <FONT COLOR="#CC0000">*</FONT></SPAN></TD>
								</TR>
								<TR> 
									<TD COLSPAN="2">&nbsp;</TD>
								...
								<TR> 
									<TD COLSPAN="2" ALIGN="CENTER"><INPUT TYPE="submit" NAME="enviar" VALUE="Enviar" CLASS="formbutton" TABINDEX="1" TITLE="Enviar la pregunta">&nbsp;<INPUT TYPE="RESET" NAME="limpiar" VALUE="Limpiar" CLASS="formbutton" TABINDEX="1" TITLE="Limpiar el formulario"></TD>
								</TR>
							</TABLE>
						</FORM>
					</TD>

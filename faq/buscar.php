<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Preguntas Frecuentes - B&uacute;squeda</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="preguntas, frecuentes, buscadores, b�squedas, motores, dudas, respuestas, computaci�n, universidades, uls, la serena, departamentos, matem�ticas, inform�tica">
<META NAME="description" CONTENT="P�gina que muestra las preguntas frecuentes encontradas por el buscador de la secci�n FAQ. Se listan las preguntas frecuentes que coinciden en la pregunta o respuesta con la palabra ingresada por el usuario.">
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde se listan todas las pregunas frecuentes que ha contestado el
						...
						*/
						...
						if ($correcto)
						{
							$consulta->buscar(5, $_GET['palabra'], $_GET['pagina']);

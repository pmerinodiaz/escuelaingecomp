<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Preguntas Frecuentes</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="preguntas, dudas, respuestas, frecuentes, computaci�n, universidades, uls, la serena, departamentos, matem�ticas, inform�tica">
<META NAME="description" CONTENT="P�gina que muestra el listado de preguntas frecuentemente realizadas por los usuarios. Tambi�n se muestra un formulario de b�squeda de preguntas frecuentes.">
...
<?PHP
/*
 * Script en donde incrementamos el n�mero de visitas del tema 'Preguntas Frecuentes'.
*/
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde se listan todas las preguntas frecuentes contestadas
						 * por el Webmaster de la Escuela IC y que est�n registradas en la Base
						 * de Datos.
						*/
						...
						if ($correcto)
						{
							$consulta->mostrar(5, $_GET['pagina']);

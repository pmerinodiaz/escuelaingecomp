...
<META NAME="description" CONTENT="P�gina en donde se presenta el formulario para que un usuario puede agregar un comentario a un tutorial.">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			...
			*/
			...
			if ($correcto)
			{
				...
				// Creamos el objeto tutorial  y mostramos el t�tulo con el nombre del apartado donde estamos.
				$tutorial = new tutorial($link);
				$tutorial->tituloComentar(2, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
        ...
        <TR> 
          <TD> 
						...
						*/
						...
						if ($correcto)
						{
							$tutorial->detallar(2, 0, 2, $_GET['id']);

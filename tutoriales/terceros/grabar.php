<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Tutoriales - De Terceros - Comentar</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="comentarios, opinar, opiniones, terceros, tutoriales, cursos, manuales, ayudas, referencias, nuevas, nuevos, documentaciones, documentos, libros, on-line, conocimientos, lenguajes, apartados, computaci�n, inform�tica, ciencias, nuestros, tecnolog�as">
<META NAME="description" CONTENT="P�gina que registra el comentario enviado por un usuario hacia un tutorial.">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			...
			*/
			...
			if ($correcto)
			{
				...
				// Creamos el objeto tutorial  y mostramos el t�tulo con el nombre del
				// apartado donde estamos.
				$tutorial = new tutorial($link);
				$tutorial->tituloComentar(2, $_POST['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
          ...
          <TD> 
						...
						*/
						...
						if ($correcto)
						{
							...
							// Creamos un objeto comentario y agregamos el comentario al tutorial.
							$comentario = new comentario($link);
							$comentario->agregar(2, $_POST['id'], $_POST['nombres'], $_POST['paterno'], $_POST['materno'], $_POST['email'], $_POST['texto']);

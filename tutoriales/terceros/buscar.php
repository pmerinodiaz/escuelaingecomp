<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Tutoriales - De Terceros - B&uacute;squeda</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="tutoriales, terceros, b�squedas, buscadores, motores, cursos, manuales, ayudas, referencias, nuevas, nuevos, documentaciones, documentos, libros, on-line, conocimientos, lenguajes, apartados, computaci�n, inform�tica, ciencias, nuestros, tecnolog�as">
<META NAME="description" CONTENT="P�gina en la cual se realiza la b�squeda de tutoriales de terceros. Se buscan los tutoriales de terceros que coincidan en el t�tulo o la descripci�n con la palabra ingresada por el usuario.">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			if ($correcto)
			{
				...
				$tutorial->tituloBusqueda(2, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde mostramos el listado de tutoriales de terceros, ordenados
						...
						*/
						...
						if ($correcto)
						{
							$tutorial->buscar(2, $_GET['id'], $_GET['palabra'], $_GET['pagina']);

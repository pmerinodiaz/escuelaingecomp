...
<META NAME="keywords" CONTENT="terceros, tutoriales, cursos, manuales, nuevas, ayudas, referencias, nuevos, documentaciones, apartados, documentos, libros, on-line, conocimientos, lenguajes, apartados, computaci�n, inform�tica, ciencias, nuestros, tecnolog�as">
<META NAME="description" CONTENT="P�gina en donde se listan en los tutoriales de terceros correspondientes al apartado elegido por el usuario. Tambi�n se muestra un formulario para que el usuario pueda buscar un tutotiral de tercero.">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			if ($correcto)
			{
				...
				$tutorial->mostrarTitulo(2, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
        ...
        <TR> 
          <TD> 
						...
						*/
						...
						if ($correcto)
						{
							$tutorial->mostrar(2, $_GET['id'], $_GET['pagina']);

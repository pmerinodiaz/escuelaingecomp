<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Tutoriales - De Terceros - Comentarios</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="tutoriales, terceros, comentarios, opinar, opiniones, cursos, manuales, ayudas, referencias, nuevas, nuevos, documentaciones, documentos, libros, on-line, conocimientos, lenguajes, apartados, computaci�n, inform�tica, ciencias, nuestros, tecnolog�as">
<META NAME="description" CONTENT="P�gina donde se muestran los comentarios que se han efectuado sobre un tutorial.">
      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				$tutorial->tituloComentarios(2, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde mostramos el detalle del tutorial elegido por el usuario
						...
						*/
						...
						if ($correcto)
						{
							...
							// Mostramos el detalle del tutorial elegido y los comentarios.
							$tutorial->detallar(2, 0, 3, $_GET['id']);

<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Tutoriales - De Terceros - Acceso</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="tutoriales, terceros, accesos, acceder, downloads, descargas, descargar, bajar, cursos, manuales, ayudas, referencias, nuevas, nuevos, documentaciones, documentos, libros, on-line, conocimientos, lenguajes, apartados, computaci�n, inform�tica, ciencias, nuestros, tecnolog�as">
<META NAME="description" CONTENT="P�gina en donde descargamos el archivo que contiene el tutorial, o bien nos enlazamos al sitio del tutorial de terceros. Tambi�n mostramos detalles del tutorial descargado.">
...
if (isset($_GET['id']) && $_GET['id'] != NULL && is_numeric($_GET['id']))
{
	...
	// Creamos el objeto tutorial y nos enlazamos al url del tutorial.
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
            <?PHP
			/*
			 * Script en donde mostramos el t�tulo del apartado donde estamos
			 * y la navegaci�n 'ubicaci�n'.
			*/
			
			// Cuando los par�metros son v�lidos.
			if ($correcto)
				$tutorial->tituloAcceso(2, $_GET['id']);
			// Cuando los par�metros no son v�lidos.
			else
			{
				// Librer�as necesarias.
        ...
        <TR> 
          <TD> 
						...
						*/
						...
						if ($correcto)
						{
							$tutorial->detallar(2, 1, 1, $_GET['id']);

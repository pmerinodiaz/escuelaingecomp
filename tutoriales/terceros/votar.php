<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Tutoriales - De Terceros - Votaci&oacute;n</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="tutoriales, terceros, votaciones, votar, votos, calificar, calificaciones, cursos, manuales, ayudas, referencias, nuevas, nuevos, documentaciones, documentos, libros, on-line, conocimientos, lenguajes, apartados, computaci�n, inform�tica, ciencias, nuestros, tecnolog�as">
<META NAME="description" CONTENT="P�gina en la cual se muestra el formulario de votaci�n para que usuario pueda calificar un tutorial.">
...
// Cuando loa par�metros son v�lidos.
if (isset($_GET['id']) && $_GET['id'] != NULL && is_numeric($_GET['id']))
	$correcto = true;
// Cuando loa par�metros no son v�lidos.
else $correcto = false;
?>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			if ($correcto)
			{
				...
				$tutorial->tituloVotar(2, $_GET['id']);
			}
        ...
        <TR> 
          <TD> 
						...
						*/
						...
						if ($correcto)
						{
							$tutorial->detallar(2, 0, 4, $_GET['id']);

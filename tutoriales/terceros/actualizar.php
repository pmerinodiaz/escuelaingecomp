...
<META NAME="keywords" CONTENT="tutoriales, terceros, votaciones, votar, votos, calificar, calificaciones, cursos, manuales, nuevas, nuevos, documentaciones, documentos, libros, on-line, conocimientos, lenguajes, apartados, computaci�n, inform�tica, ciencias, nuestros, tecnolog�as">
<META NAME="description" CONTENT="P�gina que registra la votaci�n efectuada por el usuario a un tutorial.">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			if ($correcto)
			{
				...
				$tutorial->tituloVotar(2, $_POST['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{

<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Tutoriales - Nuestros - Acceso</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="accesos, descargas downloads, tutoriales, cursos, manuales, ayudas, referencias, nuestros, nuevas, nuevos, documentaciones, documentos, libros, on-line, conocimientos, lenguajes, apartados, computaci�n, inform�tica, ciencias, terceros, tecnolog�as">
<META NAME="description" CONTENT="P�gina en donde descargamos el archivo del tutorial o bien nos enlazamos al sitio donde est� el tutorial. Tambi�n mostramos detalles del tutorial visitado.">
...
// Cuando los par�metros sn v�lidos.
if (isset($_GET['id']) && $_GET['id'] != NULL && is_numeric($_GET['id']))
{
	...
	// Creamos el objeto tutorial.
	$tutorial = new tutorial($link);
	
	// Nos enlazamos al url del tutorial.
	$url = $tutorial->url($_GET['id']);
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			if ($correcto)
				$tutorial->tituloAcceso(1, $_GET['id']);
        ...
        <TR> 
          <TD> 
						...
						*/
						...
						if ($correcto)
						{
							$tutorial->detallar(1, 1, 1, $_GET['id']);

<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Tutoriales - Nuestros - Comentarios</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="comentarios, opiniones, tutoriales, cursos, manuales, nuestros, ayudas, referencias, nuevas, nuevos, documentaciones, documentos, libros, on-line, conocimientos, lenguajes, apartados, computaci�n, inform�tica, ciencias, terceros, tecnolog�as">
<META NAME="description" CONTENT="P�gina din�mica que muestra los comentarios que se le han efectuado a un tutorial.">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			if ($correcto)
			{
				...
				// Creamos el objeto tutorial  y mostramos el t�tulo con el nombre del apartado
				// donde estamos.
				$tutorial = new tutorial($link);
				$tutorial->tituloComentarios(1, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
          ...
          <TD> 
						...
						*/
						...
						if ($correcto)
						{
							...
							$tutorial->detallar(1, 0, 3, $_GET['id']);

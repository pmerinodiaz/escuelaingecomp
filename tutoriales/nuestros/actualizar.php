...
<META NAME="keywords" CONTENT="votaciones, votos, calificaciones, tutoriales, cursos, manuales, ayudas, referencias, nuestros, nuevas, nuevos, documentaciones, documentos, libros, on-line, conocimientos, lenguajes, apartados, computaci�n, inform�tica, ciencias, terceros, tecnolog�as">
<META NAME="description" CONTENT="P�gina en donde se registra la votaci�n efectuada por el usuario hacia un tutorial.">
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
            <?PHP
			/*
			 * Script en donde mostramos el t�tulo del apartado donde estamos y la navegaci�n
			 * 'ubicaci�n'.
			*/
			...
			if ($correcto)
			{
				...
				$tutorial->tituloVotar(1, $_POST['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script que registra en la Base de Datos la votaci�n de un usuario
						 * por un tutorial.
						*/
						...
						if ($correcto)
						{
							$tutorial->votar(2, $_POST['id'], $_POST['nota']);

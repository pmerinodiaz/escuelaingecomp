...
<META NAME="keywords" CONTENT="tutoriales, cursos, manuales, ayudas, referencias, nuestros, nuevas, nuevos, documentaciones, documentos, libros, on-line, conocimientos, lenguajes, apartados, computaci�n, inform�tica, ciencias, terceros, tecnolog�as">
<META NAME="description" CONTENT="En esta p�gina se listan los tutoriales referentes al apartado elegido por el usuario. Tambi�n se muestra un formulario para que el usuario pueda buscar un tutotiral nuestros.">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			if ($correcto)
			{
				...
				$tutorial->mostrarTitulo(1, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
        ...
        <TR> 
          <TD> 
						...
						*/
						...
						if ($correcto)
						{
							$tutorial->mostrar(1, $_GET['id'], $_GET['pagina']);

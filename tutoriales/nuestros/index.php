<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Tutoriales - Nuestros</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="tutoriales, cursos, manuales, nuestros, ayudas, nuevas, nuevos, documentaciones, documentos, libros, on-line, conocimientos, lenguajes, computaci�n, inform�tica, ciencias, terceros, tecnolog�as">
<META NAME="description" CONTENT="Secci�n donde te presentamos diversos tutoriales, manuales, cursos y apuntes realizados por personas de nuestra comunidad estudiantil. Con ellos podr�s iniciarte a las tecnolog�as m�s actuales e importantes de las ciencias de la Computaci�n e Inform�tica.">
...
<?PHP
/*
 * Script en donde incrementamos el n�mero de visitas del tema 'Nuestros Tutoriales'.
*/
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR> 
					<TD WIDTH="76%" CLASS="ubicacion">Ubicaci&oacute;n: <A HREF="../../home/index.php" TITLE="Ver Home">Home</A> / <A HREF="../index.php" TITLE="Ver Tutoriales">Tutoriales</A> / Nuestros</TD>
					<TD ROWSPAN="2" WIDTH="24%" VALIGN="TOP"><IMG SRC="activos/bgnuestros.jpg" WIDTH="110" HEIGHT="45"></TD>
				</TR>
				<TR> 
					<TD WIDTH="76%" CLASS="titulo">Nuestros Tutoriales</TD>
				</TR>
				<TR> 
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
        <TR> 
          <TD WIDTH="65%" CLASS="contenido">Te presentamos diversos tutoriales, manuales, cursos y apuntes realizados por personas de nuestra comunidad estudiantil. Con ellos podr&aacute;s iniciarte a las tecnolog&iacute;as m&aacute;s actuales e importantes de las ciencias de la Computaci&oacute;n e Inform&aacute;tica.</TD>
          <TD WIDTH="35%" ALIGN="CENTER"><IMG SRC="activos/logonuestros.jpg" WIDTH="150" HEIGHT="97"></TD>
        </TR>
        <TR> 
          <TD COLSPAN="2">&nbsp;</TD>
        </TR>
        <TR> 
          <TD COLSPAN="2"> 
                        <?PHP
						/*
						 * Script en donde se listan todos los apartados que contiene al menos un tutorial
						 * creado por la gente de la Escuela IC y los �tlimos tres tutoriales nuestros
						...
						*/
						...
						// Creamos un objeto tutorial, mostramos los apartados donde hay tutoriales y mostramos
						// los tutoriales m�s detacados.
						$tutorial = new tutorial($link);
						$tutorial->apartados(1);
						$tutorial->destacados(1);

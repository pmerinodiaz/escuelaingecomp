...
<META NAME="keywords" CONTENT="comentarios, opinar, opiniones, tutoriales, cursos, manuales, ayudas, referencias, nuestros, nuevas, nuevos, documentaci�n, documentos, libros, on-line, conocimiento, lenguajes, apartados, computaci�n, inform�tica, ciencias, terceros, tecnolog�as">
<META NAME="description" CONTENT="En esta p�gina se presenta el formulario para que el usuario pueda realizar un comentario sobre un tutorial.">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			...
			*/
			...
			if ($correcto)
			{
				...
				$tutorial->tituloComentar(1, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
        ...
        <TR> 
          <TD> 
						...
						*/
						...
						if ($correcto)
						{
							$tutorial->detallar(1, 0, 2, $_GET['id']);

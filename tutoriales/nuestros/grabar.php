<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Tutoriales - Nuestros - Comentar</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="comentarios, opiniones, opinar, tutoriales, cursos, manuales, nuestros, ayudas, referencias, nuevas, nuevos, documentaciones, documentos, libros, on-line, conocimientos, lenguajes, apartados, computaci�n, inform�tica, ciencias, terceros, tecnolog�as">
<META NAME="description" CONTENT="En esta p�gina registra el comentario enviado por un usuario hacia un tutorial.">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			...
			*/
			...
			if ($correcto)
			{
				...
				$tutorial->tituloComentar(1, $_POST['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
          ...
          <TD> 
						...
						*/
						...
						if ($correcto)
						{
							...
							// Creamos un objeto comentario y agregamos el comentarios del tutorial.

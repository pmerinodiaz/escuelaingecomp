<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Tutoriales - Estad&iacute;sticas</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="tutoriales, terceros, estad�sticas, nuestros, cursos, manuales, ayudas, referencias, nuevas, nuevos, documentaciones, documentos, libros, on-line, conocimientos, lenguajes, apartados, computaci�n, inform�tica, ciencias, tecnolog�as">
<META NAME="description" CONTENT="P�gina que muestra los 3 tutoriales m�s visitados, los 3 tutoriales mas votados y los 3 tutoriales m�s comentados.">
...
<?PHP
/*
 * Script en donde incrementamos el n�mero de visitas del tema 'Estad�sticas de Tutoriales'.
*/
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR> 
					<TD WIDTH="76%" CLASS="ubicacion">Ubicaci&oacute;n: <A HREF="../../home/index.php" TITLE="Ver Home">Home</A> / <A HREF="../index.php" TITLE="Ver Tutoriales">Tutoriales</A> / Estad&iacute;sticas</TD>
					<TD ROWSPAN="2" WIDTH="24%" VALIGN="TOP"><IMG SRC="activos/bgestadisticas.jpg" WIDTH="110" HEIGHT="45"></TD>
				</TR>
				<TR> 
					<TD WIDTH="76%" CLASS="titulo">Estad&iacute;sticas de Tutoriales</TD>
				</TR>
				<TR> 
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD WIDTH="200%" COLSPAN="2"> 
                        <?PHP
						/*
						 * Script en donde se listan los 3 tutoriales mas visitas, los 3 tutoriales
						 * mas comentados y los 3 tutoriales mas votados.
						*/
						...
						// Creamos un objeto tutorial y mostramos las estad�sticas.
						$tutorial = new tutorial($link);
						$tiempo = new tiempo();
						$tutorial->estadisticas(1, $tiempo);
						$tutorial->estadisticas(2, $tiempo);
						$tutorial->estadisticas(3, $tiempo);

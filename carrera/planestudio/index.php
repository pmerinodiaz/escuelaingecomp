<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Carrera - Plan de Estudio</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="planes, estudios, asignaturas, clases, cursos, ramos, pre-grado, objetivos, espec�ficos, generales, roles, perfiles, profesionales, carreras, ingenier�as, ingenieros, titulaciones, mallas, curriculares, inform�tica, computaci�n, universidades, uls, serena">
<META NAME="description" CONTENT="En esta secci�n se muestra la informaci�n sobre el plan de estudios de la carrera. Se muestran todas las asignaturas del plan de estudio nuevo de la carrera de Ingenier�a en Computaci�n de la ULS.">
...
<?PHP
/**
 * Script en donde incrementamos el n�mero de visitas del tema 'Plan de Estudio'.
*/
...
// Creamos un objetos visitas e incrementamos las vistas par este tema.
$numero = new visitas($link);
$numero->incrementarTema(9);
?>
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR>
					<TD WIDTH="76%" CLASS="ubicacion">Ubicaci&oacute;n: <A HREF="../../home/index.php" TITLE="Ver Home">Home</A> / <A HREF="../index.php" TITLE="Ver Carrera">Carrera</A> / Plan de Estudio</TD>
					<TD ROWSPAN="2" WIDTH="24%" VALIGN="TOP"><IMG SRC="activos/bgplanestudio.jpg" WIDTH="110" HEIGHT="45"></TD>
				</TR>
				<TR>
					<TD WIDTH="76%" CLASS="titulo">Plan de Estudio</TD>
				</TR>
				<TR>
    ...
    <TD WIDTH="154" HEIGHT="540" ROWSPAN="2" VALIGN="TOP" BACKGROUND="../../librerias/bgmenu.gif">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				...
				<TR> 
					<TD BACKGROUND="../../librerias/bgbox.gif" CLASS="tema"><IMG SRC="../../librerias/awtema.gif" WIDTH="18" HEIGHT="10" BORDER="0">Plan de Estudio</TD>
				</TR>
				<TR> 
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
			<?PHP
			/**
			 * Script en donde se muestra el plan de estudio de la carrera. El plan de estudio
			 * corresponde a la lista de asignaturas correspondientes a la carreta de Ingenier�a
			 * en Computaci�n.
			*/
			...
			// Creamos el objeto asignatura y mostramos el plan de estudio.

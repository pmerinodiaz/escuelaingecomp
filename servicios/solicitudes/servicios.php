...
<META NAME="keywords" CONTENT="servicios, solicitudes, empresas, personas, trabajos, ofertas, trabajos, laborales, laburo, compromisos, encargos, solicitudes, profesiones, profesionales, alumnos, alumnado, estudiantes, acad�micos, profesores, trabajadores, ventas, compras, empleos, pr�cticas, avisos, econ�micos">
<META NAME="description" CONTENT="En esta p�gina se listan todas las solicitudes de servicios realizadas por empresas o personas y que son enviadas para que la gente de la Escuela Ingenier�a en Computaci�n de la ULS responda a ellas. Est�n ordenadas por fecha de env�o.">
...
if (isset($_GET['id']) && isset($_GET['pagina']) && $_GET['id'] != NULL && $_GET['pagina'] != NULL && is_numeric($_GET['id']) && is_numeric($_GET['pagina']))
	$correcto = true;
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
            <?PHP
			/*
			 * Script en donde creamos el objeto solicitud de servicio o bien el objeto error.
			*/
			...
			if ($correcto)
			{
				...
				// Creamos un objeto solicitud de servicio y mostramos el t�tulo de esta secci�n.
				$solicitud = new solicitudservicio($link);
				$solicitud->mostrarTitulo($_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
    ...
    <TD WIDTH="6" HEIGHT="60" VALIGN="TOP"></TD>
    <TD WIDTH="154" HEIGHT="540" ROWSPAN="2" VALIGN="TOP" BACKGROUND="../../librerias/bgmenu.gif"><TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
        <TR> 
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP"><TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde mostramos el listado de solicitudes de servicios, ordenadas
						 * por fecha de env�o.
						*/
						...
						if ($correcto)
						{
							$solicitud->mostrar($_GET['id'], $_GET['pagina']);

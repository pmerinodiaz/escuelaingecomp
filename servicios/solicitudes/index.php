<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Servicios - Solicitudes</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="servicios, solicitudes, ofertas, trabajos, laborales, laburos, compromisos, laborales, encargos, solicitudes, profesiones, profesionales, alumnos, alumnados, estudiantes, acad�micos, profesores, trabajadores, ventas, compras, empleos, pr�cticas, avisos, econ�micos">
<META NAME="description" CONTENT="En esta p�gina se listan las ofertas de servicios recibidas desde empresas o personas y que son enviadas para que las personas de nuestra Escuela responda a ellas.">
...
<?PHP
/*
 * Script en donde incrementamos el n�mero de visitas del tema 'Solicitudes de Servicios'.
*/
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR> 
          <TD WIDTH="76%" CLASS="ubicacion">Ubicaci&oacute;n: <A HREF="../../home/index.php" TITLE="Ver Home">Home</A> / <A HREF="../index.php" TITLE="Ver Servicios">Servicios</A> / Solicitudes</TD>
					<TD ROWSPAN="2" WIDTH="24%" VALIGN="TOP"><IMG SRC="activos/bgsolicitudes.jpg" WIDTH="110" HEIGHT="45"></TD>
				</TR>
				<TR> 
          <TD WIDTH="76%" CLASS="titulo">Solicitudes de Servicios</TD>
				</TR>
				<TR> 
    ...
    <TD WIDTH="154" HEIGHT="540" ROWSPAN="2" VALIGN="TOP" BACKGROUND="../../librerias/bgmenu.gif">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				...
				<TR> 
          <TD BACKGROUND="../../librerias/bgbox.gif" CLASS="tema"><A HREF="../ofertas/index.php" TITLE="Ver Ofertas de Servicios"><IMG SRC="../../librerias/awtema.gif" ALT="Ver Ofertas de Servicios" WIDTH="18" HEIGHT="10" BORDER="0">Ofertas</A></TD>
				</TR>
				<TR> 
          <TD BACKGROUND="../../librerias/bgbox.gif" CLASS="tema"><IMG SRC="../../librerias/awtema.gif" WIDTH="18" HEIGHT="10" BORDER="0">Solicitudes</TD>
				</TR>
				<TR> 
					<TD BACKGROUND="../../librerias/bgbox.gif"><IMG SRC="../../librerias/pxtransparente.gif" WIDTH="1" HEIGHT="10"></TD>
				</TR>
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR> 
					<TD WIDTH="65%" VALIGN="TOP" CLASS="contenido"><P>En esta secci&oacute;n te damos a conocer un listado con todas las solicitudes de servicios, que tanto las empresas como las personas, han enviado a nuestra Escuela.</P></TD>
					<TD WIDTH="35%" ALIGN="CENTER"><IMG SRC="activos/logosolicitudes.jpg" WIDTH="124" HEIGHT="79"></TD>
				</TR>
				<TR> 
					<TD COLSPAN="2">&nbsp;</TD>
				</TR>
				<TR> 
					<TD COLSPAN="2">
						<?PHP
						/*
						 * Script en donde se listan todos los servicios que contiene solicitudes de servicios
						 * enviadas por empresa o personas a la Escuela IC.
						*/
						
						// Librer�as necesarias.
						include("../../librerias/servicio.php");
						include("../../librerias/solicitudservicio.php");
						
						// Creamos el objeto solicitud y mostramos los servicios que tiene solicitudes de
						// servicios.
						$servicio = new servicio($link);
						$solicitud = new solicitudservicio($link);
						$servicio->mostrar(6);
						$solicitud->destacadas();

<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Servicios - Solicitudes - B&uacute;squeda</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="b�squedas, buscadores, motores, servicios, solicitudes, empresas, personas, trabajos, ofertas, trabajos, laborales, laburos, compromisos, encargos, solicitudes, profesi�n, profesionales, alumnos, alumnado, estudiantes, acad�micos, profesores, trabajadores, ventas, empleo, pr�cticas, avisos, compras, econ�micos">
<META NAME="description" CONTENT="En esta p�gina se listan todas las solicitudes de servicios resultantes de la b�squeda realizada por el usuario en las solicitudes de servicios. Se buscan las solicitudes de servicios que coincidan en el t�tulo o la descripci�n con la palabra ingresada por el usuario.">
...
if (isset($_GET['id']) && isset($_GET['palabra']) && isset($_GET['pagina']) && $_GET['id'] != NULL && $_GET['palabra'] != NULL && $_GET['pagina'] != NULL && is_numeric($_GET['id']) && is_string($_GET['palabra']) && is_numeric($_GET['pagina']))
	$correcto = true;
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
            <?PHP
			/*
			 * Script en donde creamos el objeto solicitud o bien el objeto error.
			*/
			...
			if ($correcto)
			{
				...
				// Creamos un objeto solicitud y mostramos el t�tulo de esta secci�n.
				$solicitud = new solicitudservicio($link);
				$solicitud->tituloBusqueda($_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde mostramos el listado de solicitudes de servicios coincidentes
						 * en el t�tulo o descripci�n con la palabra ingresada por el usuario y se ordenan
						 * por fecha de env�o.
						*/
						...
						if ($correcto)
						{
							$solicitud->buscar($_GET['id'], $_GET['palabra'], $_GET['pagina']);

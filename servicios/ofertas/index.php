<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Servicios - Ofertas</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="servicios, ofertas, oferentes, trabajos, laborales, laburos, ofrecimientos, ventas, empleo, compras, practicas, avisos, econ�micos, solicitudes, compromisos, laborales, encargos, solicitudes, profesionales, alumnos, alumnado, estudiantes, acad�micos, profesores, trabajadores">
<META NAME="description" CONTENT="P�gina en donde se muestran todas las ofertas de servicios realizadas por gente de la Escuela Ingenier�a en Computaci�n de la ULS a la comunidad y que se refieren a la computaci�n.">
...
<?PHP
/*
 * Script en donde incrementamos el n�mero de visitas del tema 'Ofertas de Servicios'.
*/
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR> 
          <TD WIDTH="76%" CLASS="ubicacion">Ubicaci&oacute;n: <A HREF="../../home/index.php" TITLE="Ver Home">Home</A> / <A HREF="../index.php" TITLE="Ver Servicios">Servicios</A> / Ofertas</TD>
					<TD ROWSPAN="2" WIDTH="24%" VALIGN="TOP"><IMG SRC="activos/bgofertas.jpg" WIDTH="110" HEIGHT="45"></TD>
				</TR>
				<TR> 
          <TD WIDTH="76%" CLASS="titulo">Ofertas de Servicios</TD>
				</TR>
				<TR> 
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR> 
					<TD WIDTH="74%" CLASS="contenido">A continuaci&oacute;n presentamos un listado de todas las ofertas de servicios que ofrece gente de nuestra Escuela, a toda la comunidad de Chile y mundial, subcategorizadas por el tipo de servicio que se presta.</TD>
					<TD WIDTH="26%" ALIGN="CENTER"><IMG SRC="activos/logoofertas.gif" WIDTH="69" HEIGHT="90"></TD>
				</TR>
				<TR> 
					<TD COLSPAN="2">&nbsp;</TD>
				</TR>
				<TR> 
					<TD COLSPAN="2">
						<?PHP
						/*
						 * Script en donde se listan todos los tipos de servicios que contiene ofertas de
						 * servicios enviadas por gente de la Escuela IC.
						*/
						...
						// Creamos el objeto servicio y mostramos los tipos de servicios que tiene ofertas
						// de servicios.
						$servicio = new servicio($link);
						$oferta = new ofertaservicio($link);
						$servicio->mostrar(5);
						$oferta->destacadas();

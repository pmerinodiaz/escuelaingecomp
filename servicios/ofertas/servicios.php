...
<META NAME="keywords" CONTENT="servicios, ofertas, oferentes, trabajo, laborales, laburos, solicitudes, compromisos, laborales, encargos, profesiones, profesionales, alumnos, alumnado, estudiantes, acad�micos, profesores, trabajadores, ofrecimientos, ventas, compras, empleos, pr�cticas, avisos">
<META NAME="description" CONTENT="En esta p�gina se listan todas las ofertas de servicios realizadas por gente de la Escuela Ingenier�a en Computaci�n de la ULS a la comunidad y que se refieren a la computaci�n. Est�n ordenadas por fecha de env�o.">
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde mostramos el listado de ofertas de servicios,
						 * ordenadas por fecha de env�o.
						*/
						
						// Cuando los par�metros no son v�lidos.
						if ($correcto)
						{
							$oferta->mostrar($_GET['id'], $_GET['pagina']);

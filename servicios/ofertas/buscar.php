<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Servicios - Ofertas - B&uacute;squeda</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="b�squedas, buscadores, motores, servicios, ofertas, oferentes, trabajos, laborales, laburos, solicitudes, compromisos, laborales, encargos, solicitudes, profesiones, profesionales, alumnos, alumnado, estudiantes, acad�micos, profesores, trabajadores, ofrecimientos, ventas, compras, empleo, pr�cticas, avisos">
<META NAME="description" CONTENT="En esta p�gina se listan todas las ofertas de servicios resultantes de la b�squeda del usuario de ofertas de servicios. Se buscan las ofertas de servicios que coincidan en el t�tulo o la descripci�n con la palabra ingresada por el usuario.">
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
            <?PHP
			/*
			 * Script en donde creamos el objeto oferta o bien el objeto error.
			*/
			...
			if ($correcto)
			{
				...
				// Creamos un objeto oferta y mostramos el t�tulo de esta secci�n.
				$oferta = new ofertaservicio($link);
				$oferta->tituloBusqueda($_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
						<?PHP
						/*
						 * Script en donde mostramos el listado de ofertas de servicios coincidentes
						...
						*/
						...
						if ($correcto)
						{
							$oferta->buscar($_GET['id'], $_GET['palabra'], $_GET['pagina']);

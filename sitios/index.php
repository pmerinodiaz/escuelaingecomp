<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Sitios de Inter&eacute;s</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="sitios, inter�s, p�ginas, webs, v�nculos, links, recomendados, recomendaciones, websites, sites, portales, enlaces, amigos">
<META NAME="description" CONTENT="En esta secci�n se encuentran recopiladas varias direcciones de p�ginas Web, que creemos interesantes para la comunidad estudiantil de la Escuela. Entre estas p�ginas se encuentran Revistas de Computaci�n, Sitios Oficiales, Hardware, Software y otros.">
...
<?PHP
/*
 * Script en donde incrementamos el n�mero de visitas del tema 'Sitios de Inter�s'.
*/
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde se listan todas los sitios de inter�s que tiene este Web.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$sitio->mostrar($_GET['pagina']);

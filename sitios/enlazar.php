<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Sitios de Inter&eacute;s - Enlazar</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="sitios, inter�s, p�ginas, webs, v�nculos, recomendados, recomendadas, recomendaciones, websites, sites, portales, enlaces, links, amigos, enlazar, vincular, accesos">
<META NAME="description" CONTENT="P�gina en donde se muestran los detalles del sitio de inter�s especificado por el usuario. Se muestra su nombre, imagen, descripci�n, url y n�mero de visitas. Al momento de cargarse esta p�gina, se abre autom�ticamente la p�gina del sitio de inter�s.">
...
<?PHP
/*
 * Script que verifica que vengan todos los par�metros en la URL para as� escribir en el body
 * de la p�gina, ya que en este TAG se llama evento onLoad que abre el sitio Web de inter�s.
*/
...
if (isset($_GET['id']) && $_GET['id'] != NULL && is_numeric($_GET['id']))
{
	...
	// Creamos el objeto sitio de inter�s y nos enlazamos al sitio Web.
	$sitio = new sitiointeres($link);
	$url = $sitio->url($_GET['id']);
	$body = $body . " onLoad=\"openWindow('http://" . $url . "','','toolbar=yes,location=yes,status=yes,menubar=yes,scrollbars=yes,resizable=yes')\">";
}
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
            <?PHP
			/*
			 * Script mostramos el t�tulo donde se muestra el nombre del sitio de inter�s
			 * donde estamos y la navegaci�n 'ubicaci�n'.
			*/
			
			// Cuando los par�metros son v�lidos.
			if ($correcto)
				$sitio->tituloAcceso($_GET['id']);
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde se muestra informaci�n del sitio Web elegido por el usuario.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$sitio->detallar($_GET['id']);

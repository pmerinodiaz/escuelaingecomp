<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Integrantes - Alumnos - B&uacute;squeda</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="b�squedas, buscadores, motores, nombres, cec, alumnos, alumnado, disc�pulos, j�venes, estudiantes, universitarios, computacion, integrantes, academicos, ex-alumnos, administrativos, ayudantes">
<META NAME="description" CONTENT="P�gina que muestra a todos los alumnos obtenidos de la b�squeda de alumnos realizada por el usuario. Se muestra el nombre completo, el e-amil y el url de la persona.">
...
if (isset($_GET['nombres']) && isset($_GET['apellidos']) && isset($_GET['pagina']) && $_GET['nombres'] != NULL && $_GET['apellidos'] != NULL && $_GET['pagina'] != NULL && is_string($_GET['nombres']) && is_string($_GET['apellidos']) && is_numeric($_GET['pagina']))
	$correcto = true;
  ...
  <tr>
    ...
    <td width="154" height="540" rowspan="2" valign="top" background="../../librerias/bgmenu.gif">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				...
				<TR> 
					<TD BACKGROUND="../../librerias/bgbox.gif" CLASS="tema"><IMG SRC="../../librerias/pxtransparente.gif" WIDTH="25" HEIGHT="1"><A HREF="../academicos/media/index.php" title="Ver Media Acad&eacute;micos Jornada">&#149; Media Jornada</A></TD>
				</TR>
				<TR> 
    ...
    <td width="460" height="480" colspan="4" valign="top">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde mostramos los resultados de la b�squeda de alumnos realizada
						 * por el usuario. Se muestran las personas que coinciden con el nombre y apellido
						 * ingresado.
						*/
						...
						if ($correcto)
						{
							$alumno->buscar($_GET['nombres'], $_GET['apellidos'], $_GET['pagina']);

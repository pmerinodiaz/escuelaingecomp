<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Integrantes - Administrativos - Curriculum</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="administrativos, personal, secretarias, jefes, trabajadores, curriculum, vitae, ex-alumnos, cec, alumnos, computaci�n, integrantes, acad�micos, ayudantes">
<META NAME="description" CONTENT="En esta p�gina se muestra el curriculum del administrativo que el usuario seleccion� anteriormente en la p�gina index.php. Se muestra el nombre, la foto, el cargo, el e-mail y el horario de atenci�n.">
...
<?PHP
/*
 * Scripen en donde verificamos que vengan todos los par�metros en la URL.
*/
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			if ($correcto)
			{
				...
				// Creamos un objeto curr�culum y cargamos los datos del administrativo.
				$vitae = new curriculum($link, $_GET['id']);
				$vitae->cargarAdministrativo();
				$vitae->tituloAdministrativo();
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP"> 
            <?PHP
			/*
			 * Script en donde se muestra el curriculum del administrativo elegido por el usuario.
			*/
			
			// Cuando los par�metros son v�lidos.
			if ($correcto)
			{
				$vitae->datosAdministrativo();

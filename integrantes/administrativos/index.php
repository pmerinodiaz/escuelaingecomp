<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Integrantes - Administrativos</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="administrativos, personal, trabajadores, secretarias, jefes, ex-alumnos, cec, alumnos, j�venes, estudiantes, computaci�n, integrantes, acad�micos, ayudantes">
<META NAME="description" CONTENT="P�gina en donde se muestra el listado del personal administrativo que trabaja para la Escuela Ingenier�a en Computaci�n. Cada administrativo tiene asociado un curriculum.">
...
<?PHP
/*
 * Script en donde incrementamos el n�mero de visitas del tema 'Administrativos'.
*/
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR>          
					<TD WIDTH="76%" CLASS="ubicacion">Ubicaci&oacute;n: <A HREF="../../home/index.php" TITLE="Ver Home">Home</A> / <A HREF="../index.php" TITLE="Ver Integrantes">Integrantes</A> / Administrativos</TD>
					<TD ROWSPAN="2" WIDTH="24%" VALIGN="TOP"><IMG SRC="activos/bgadministrativos.jpg" WIDTH="110" HEIGHT="45"></TD>
				</TR>
				<TR> 
					<TD WIDTH="76%" CLASS="titulo">Administrativos</TD>
				</TR>
				<TR> 
    ...
    <TD WIDTH="154" HEIGHT="540" ROWSPAN="2" VALIGN="TOP" BACKGROUND="../../librerias/bgmenu.gif">
        ...
        <TR> 
          <TD BACKGROUND="../../librerias/bgbox.gif" CLASS="tema"><IMG SRC="../../librerias/awtema.gif" WIDTH="18" HEIGHT="10" BORDER="0" ALT="Ver Administrativos">Administrativos</TD>
        </TR>
        <TR> 
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
        <TR> 
          <TD CLASS="contenido">En esta secci&oacute;n te mostramos la lista del personal administrativo que est&aacute; vinculado a la Escuela Ingenier&iacute;a en Computaci&oacute;n.</TD>
        </TR>
        <TR>
          <TD>&nbsp;</TD>
        </TR>
        <TR> 
          <TD CLASS="contenido">
						<?PHP
						/*
						 * Script en donde mostramos la lista de persona administrativo vinculado a la
						 * Escuela IC.
						*/
						...
						// Creamos un objeto de la clase administrativo y mostramos el listado de
						// personal administrivo.
						$lista = new administrativo($link);
						$lista->mostrar();

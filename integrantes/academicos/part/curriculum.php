<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Integrantes - Acad&eacute;micos - Part-Time - Curriculum</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="acad�micos, profesores, estudiosos, investigadores, profesorado, colegiados, expertos, part-time, part, time, asignaturas, clases, cursos, publicaciones, libros, investigaciones, alumnos, ex-alumnos, administrativos, ayudantes, integrantes, curriculum, vitae">
<META NAME="description" CONTENT="P�gina en donde se muestra el curriculum de un acad�mico part-time de la Escuela Ingenier�a en Computaci�n. Se muestra su nombre, grado acad�mico, t�tulo profesional, email, sitio web, asignaturas dictadas y publicaciones.">
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			if ($correcto)
			{
				...
				// Creamos un objeto curr�culum y cargamos los datos del acad�mico.
				$vitae = new curriculum($link, $_GET['id']);
				$vitae->cargarAcademico();
				$vitae->tituloAcademico(3);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP"> 
            <?PHP
			/*
			 * Script en donde se muestra el curriculum del acad�mico part-time elegido por el usuario.
			*/

<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Integrantes - Acad&eacute;micos - Media Jornada</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="acad�micos, profesores, estudiosos, profesorado, investigadores, colegiados, expertos, jornadas, medias, alumnos, ex-alumnos, administrativos, ayudantes, integrantes">
<META NAME="description" CONTENT="En esta p�gina se muestra la lista de acad�micos de media jornada que tiene el Area de Computaci�n. Cada nombre de acad�mico se enlaza a la p�gina en donde se muestra su curriculum.">
...
<?PHP
/*
 * Script en donde incrementamos el n�mero de visitas del tema 'Acad�micos Media Jornada'.
*/
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="460" height="60" colspan="4" valign="top">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR> 
					<TD WIDTH="76%" CLASS="ubicacion">Ubicaci&oacute;n: <A HREF="../../../home/index.php" TITLE="Ver Home">Home</A> / <A HREF="../../index.php" TITLE="Ver Integrantes">Integrantes</A> / <A HREF="../index.php" TITLE="Ver Acad&eacute;micos">Acad&eacute;micos</A> / Media Jornada</TD>
					<TD ROWSPAN="2" WIDTH="24%" VALIGN="TOP"><IMG SRC="activos/bgmediajornada.jpg" WIDTH="110" HEIGHT="45"></TD>
				</TR>
				<TR> 
					<TD WIDTH="76%" CLASS="titulo">Acad&eacute;micos Media Jornada</TD>
				</TR>
				<TR> 
  ...
  <tr>
    ...
    <td width="460" height="480" colspan="4" valign="top">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR>
					<TD CLASS="contenido">En esta secci&oacute;n te mostramos la lista de acad&eacute;micos media jornada, vinculados a la Escuela Ingenier&iacute;a en Computaci&oacute;n.</TD>
				</TR>
				<TR> 
					<TD>&nbsp;</TD>
				</TR>
          ...
          <TD CLASS="contenido">
                        <?PHP
						/*
						 * Script en donde mostramos la lista de acad�micos media jornada de la Escuela.
						*/
						
						// Librer�as necesarias.
						include("../../../librerias/academico.php");
						
						// Creamos un objeto de la clase academico y listamos los acad�micos media jornada.

<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Integrantes - CEC - A&ntilde;o</TITLE>
...
<META NAME="description" CONTENT="P�gina que contiene informaci�n de los alumnos que integran el directorio del CEC de la Escuela Ingenier�a en Computaci�n de la ULS. Se muestra el listado de integrantes para el a�o elegido con susrespectivos correos electr�nicos.">
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="460" height="60" colspan="4" valign="top">
            <?PHP
			/**
			 * Script en donde creamos el objeto cec o bien el objeto error, dependiendo de si
			 * los par�metros fueron recibidos con �xito. En caso de recibirlos, entonces se
			 * procede a mostrar a los alumnos del CEC. En caso contrario, se muestra al usuario
			...
			*/
			...
			if ($correcto)
			{
				...
				// Creamos un objeto cec y mostramos el t�tulo de esta secci�n.
				$cec = new cec($link);
				$cec->titulo($_GET['anio']);
			}
    ...
    <td width="154" height="540" rowspan="2" valign="top" background="../../librerias/bgmenu.gif">
        ...
        <TR> 
          <TD BACKGROUND="../../librerias/bgbox.gif" CLASS="tema"><IMG SRC="../../librerias/awtema.gif" WIDTH="18" HEIGHT="10" BORDER="0">CEC</TD>
        </TR>
        <TR> 
        ...
        <TR> 
          <TD BACKGROUND="../../librerias/bgbox.gif" CLASS="tema"><A HREF="../ayudantes/ayudantes.php" title="Ver Ayudantes"><IMG SRC="../../librerias/awtema.gif" WIDTH="18" HEIGHT="10" BORDER="0">Ayudantes</A></TD>
        </TR>
        <TR> 
          <TD BACKGROUND="../../librerias/bgbox.gif"><IMG SRC="../../librerias/pxtransparente.gif" WIDTH="1" HEIGHT="10"></TD>
        </TR>
    ...
    <td width="460" height="480" colspan="4" valign="top">
        ...
        <TR> 
          <TD WIDTH="100%" height="19" CLASS="contenido">
                        <?PHP
						/**
						 * Script en donde se muestra el listado de alumnos del CEC.
						*/
						
						// Cuando los par�metros fueron recibidos.
						if ($correcto)
						{
							$cec->mostrar($_GET['anio']);

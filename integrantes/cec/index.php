<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Integrantes - CEC</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="cec, alumnos, alumnado, disc�pulos, j�venes, universitarios, centros, estudiantes, computaci�n, integrantes, acad�micos, directivas, dirigentes, ex-alumnos, administrativos, ayudantes">
<META NAME="description" CONTENT="P�gina en donde se muestra informaci�n del CEC (Centro de Estudiantes de Computaci�n). Adem�s se muestra a los alumnos integrantes de la directiva actual del CEC.">
...
<?PHP
/**
 * Script en donde incrementamos el n�mero de visitas del tema 'CEC'.
*/
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="460" height="60" colspan="4" valign="top">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR> 
					<TD WIDTH="76%" CLASS="ubicacion">Ubicaci&oacute;n: <A HREF="../../home/index.php" TITLE="Ver Home">Home</A> / <A HREF="../index.php" TITLE="Ver Integrantes">Integrantes</A> / CEC</TD>
					<TD ROWSPAN="2" WIDTH="24%" VALIGN="TOP"><IMG SRC="activos/bgcec.jpg" WIDTH="110" HEIGHT="45"></TD>
				</TR>
				<TR> 
      		<TD WIDTH="76%" CLASS="titulo">Centro Estudiantes Computaci&oacute;n</TD>
				</TR>
				<TR> 
    ...
    <td width="154" height="540" rowspan="2" valign="top" background="../../librerias/bgmenu.gif">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				...
				<TR> 
					<TD BACKGROUND="../../librerias/bgbox.gif" CLASS="tema"><IMG SRC="../../librerias/awtema.gif" WIDTH="18" HEIGHT="10" BORDER="0" ALT="Ver CEC">CEC</TD>
				</TR>
				<TR> 
  ...
  <tr>
    ...
    <td width="460" height="480" colspan="4" valign="top">
			<table width="100%" height="98" border="0" cellpadding="0" cellspacing="0" mm_noconvert="TRUE">
				<tr> 
					<td width="63%" class="contenido">El CEC esta compuesto por una Directiva, formada por 5 integrantes, los que presiden el Centro de Estudiantes Carrera Ingenier&iacute;a en Computaci&oacute;n, el cual es la m&aacute;xima instancia de participaci&oacute;n y resoluci&oacute;n estudiantil.</td>
					<td width="37%" align="CENTER"><IMG SRC="activos/logocec.gif" WIDTH="170" HEIGHT="100"></td>
				</tr>
				<tr> 
					<td colspan="2">&nbsp;</td>
				</tr>
				<tr> 
					<td colspan="2" class="contenido"> 
						<?PHP
						/*
						 * Script en donde mostramos a los integrantes del CEC del a�o actual.
						*/
						
						// Librer�as necesarias.
						include("../../librerias/cec.php");
						
						// Creamos un objeto cec y mostramos a los cec.
						$cec = new cec($link);
						$cec->mostrarAnio();

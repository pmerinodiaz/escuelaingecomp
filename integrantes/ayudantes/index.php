<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Integrantes - Ayudantes</TITLE>
...
<?PHP
/*
 * Script en donde incrementamos el n�mero de visitas del tema 'Ayudantes'.
*/
...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="460" height="60" colspan="4" valign="top">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR> 
          <TD WIDTH="76%" CLASS="ubicacion">Ubicaci&oacute;n: <A HREF="../../home/index.php" TITLE="Ver Home">Home</A> / <A HREF="../index.php" TITLE="Ver Integrantes">Integrantes</A> / Ayudantes</TD>
          <TD ROWSPAN="2" WIDTH="24%" VALIGN="TOP"><IMG SRC="activos/bgayudantes.jpg" WIDTH="110" HEIGHT="45"></TD>
				</TR>
				<TR> 
          <TD WIDTH="76%" CLASS="titulo">Ayudantes</TD>
				</TR>
				<TR> 
  ...
  <tr>
    ...
    <td width="460" height="480" colspan="4" valign="top">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
        <TR> 
          <TD WIDTH="57%" VALIGN="TOP" CLASS="contenido">En el marco del Sistema de Ayudant&iacute;as, que viene desarrollando el <A HREF="http://fciencias.userena.cl/index.php/unidad/index/departamento/departamento_de_matem_ticas" TARGET="_blank" TITLE="Visitar Web de Departamento de Matem&aacute;ticas">Departamento de Matem&aacute;ticas</A> de la <A HREF="http://www.userena.cl" TARGET="_blank" TITLE="Visitar Web de Universidad de La Serena">Universidad de La Serena</A> desde sus primeros a&ntilde;os, que apunta a mejorar la atenci&oacute;n docente de sus alumnos, los ayudantes realizan un valioso aporte en la permanente perfecci&oacute;n docente dentro de nuestra Escuela y la Universidad.</P></TD>
          <TD WIDTH="43%" ALIGN="CENTER" VALIGN="TOP"><IMG SRC="activos/logoayudantes.jpg" WIDTH="180" HEIGHT="143"></TD>
        </TR>
        <TR> 
          <TD height="19" COLSPAN="2" CLASS="contenido"> 
                        <?PHP
						/*
						 * Script para mostrar los a�os en los cuales hay ayudant�as.
						*/
						
						// Librer�as necesarias.
						include("../../librerias/ayudante.php");
						
						// Creamos un objeto de la clase ayudante y listamos las ayudant�as.
						$ayudante = new ayudante($link);
						$ayudante->mostrarAnio();

<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Pr&aacute;ctica - Ofertas</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="reglamentos, pr�cticas, experiencias, conocimientos, profesionales, expertos, cient�ficos, reg�menes, documentos, ofertas, estatutos, plazos, consejos, empresa, solicitudes, necesidades, inform�tica, computaci�n, laboral, empleos, trabajos, laborales, avisos, econ�micos">
<META NAME="description" CONTENT="En esta p�gina se muestran todas las ofertas de pr�cticas que han hecho las empresas, personas, etc. y que se refieren a la computaci�n o la inform�tica.">
...
<?PHP
/*
 * Script en donde incrementamos el n�mero de visitas del tema 'Ofertas de Pr�ctica'.
*/
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
            <?PHP
			/*
			 * Script en donde creamos el objeto practica o bien el objeto error.
			*/
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde se muestra un listado de todas las solicitud de pr�ctica
						 * profesional realizadas a la Escuela Ingenier�a en Computaci�n.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$practica->mostrar($_GET['pagina']);

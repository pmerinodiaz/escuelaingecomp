<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Encuestas - Resultados</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="encuestas, resultados, preguntas, alternativas, estad�sticas, historiales, recopilaciones, participantes, votaciones, votar, participar, resultados, graficos, gr�ficas">
<META NAME="description" CONTENT="P�gina donde se muestran los resultados gr�ficos y estad�sticos de la encuesta elegida por el usuario.">
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP"> 
            <?PHP
			/*
			 * Script en donde se muestran los resultados obtenidos en una encuesta.
			*/
			
			// Cuando los par�metros son v�lidos.
			if ($correcto)
			{
				$encuesta->detallar($_GET['id']);

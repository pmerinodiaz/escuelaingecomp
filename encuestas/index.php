<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Encuestas</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="encuestas, preguntas, alternativas, estad�sticas, historiales, recopilaciones, participantes">
<META NAME="description" CONTENT="P�gina en la que se muestra el listado de encuestas realizadas en el Sitio Web. Se despliega para cada encuesta el formulario para que el usuario pueda votar y los resultados obtenidos.">
...
<?PHP
/*
 * Script en donde incrementamos el n�mero de visitas del tema 'Encuestas'.
*/
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD WIDTH="200%"> 
                        <?PHP
						/*
						 * Script en donde se listan todas las encuestas del sitio Web.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$encuesta->mostrar($_GET['pagina']);

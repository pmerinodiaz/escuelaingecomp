<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Encuestas - B&uacute;squeda</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="encuestas, b�squedas, buscadores, motores, preguntas, alternativas, estad�sticas, historiales, recopilaciones, participantes, votaciones, votar, participar">
<META NAME="description" CONTENT="P�gina en donde se muestran los resultados obtenidos de la b�squeda de encuestas. Se depliegan las encuestas cuyas preguntas coinciden con la palabra ingresada por el usuario.">
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
            <?PHP
			/*
			 * Script en donde creamos el objeto encuesta o bien el objeto error.
			*/
			...
			if ($correcto)
			{
				...
				// Creamos un objeto encuesta y mostramos el t�tulo de esta secci�n.
				$encuesta = new encuesta($link);
				$encuesta->tituloBusqueda();
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD WIDTH="200%"> 
                        <?PHP
						/*
						 * Script en donde se listan todas las encuestas del sitio Web encontradas por
						 * el buscador de encuestas. El buscador busca coincidencias de la palabra
						 * ingresada con las pregunta de la encuesta.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$encuesta->buscar($_GET['palabra'], $_GET['pagina']);

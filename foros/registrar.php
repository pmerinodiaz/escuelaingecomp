<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Foros - Agregar Mensaje</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="foros, temas, agregar, consultar, consultas, enviar, mensajes, discusiones, comentarios, conversar, conversaciones, forums, comentarios, preguntar, preguntas, dudar, dudas, cuestionarios, estudiantes, profesores, alumnos, acad�micos, inform�tica, computaci�n, ciencias, lenguajes, programaci�n, universidades, uls, serena, la serena, escuelas">
...
if (!isset($_POST['nombres']) || !isset($_POST['paterno']) || !isset($_POST['materno']) || !isset($_POST['email']) || !isset($_POST['asunto']) || !isset($_POST['notificacion']) || !isset($_POST['texto']) || !isset($_POST['id']) || !isset($_POST['id_envio']))
	$correcto = false;
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			...
			*/
			...
			if ($correcto)
			{
				...
				$foro = new foro($link);
				$foro->tituloAgregarNota(2, $_POST['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD WIDTH="400%" COLSPAN="2"> 
                        <?PHP
						/*
						 * Script en donde registramos en la base de datos el mensaje enviado por
						 * el usuario.
						*/
						...
						if ($correcto)
						{
							$foro->agregarNota("tema.php?id=" . $_POST['id_envio'] . "&pagina=1", $_POST['nombres'], $_POST['paterno'], $_POST['materno'], $_POST['email'], $_POST['asunto'], $_POST['notificacion'], $_POST['texto'], $_POST['id'], $_POST['id_envio']);

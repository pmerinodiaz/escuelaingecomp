<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Foros - B&uacute;squeda</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="foros, b�squedas, buscadores, motores, discusiones, comentarios, conversar, conversaciones, forums, comentarios, preguntar, preguntas, dudar, dudas, cuestionarios, estudiantes, profesores, alumnos, acad�micos, inform�tica, computaci�n, ciencias, lenguajes, programaci�n, universidades, uls, serena, la serena, escuelas">
<META NAME="description" CONTENT="En esta p�gina se muestran los resultados obtenidos de la b�squeda de foros realizada por el usuario. Se seleccionan los temas que coinciden en el t�tulo o la descripci�n o en el nombre de la persona, con la palabra ingresada por el usuario.">
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD WIDTH="400%" COLSPAN="2">
                        <?PHP
						/*
						 * Script en donde mostramos el listado de mensajes, ordenados por fecha de env�o.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$foro->buscar($_GET['id'], $_GET['palabra'], $_GET['pagina']);

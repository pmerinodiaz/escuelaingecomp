...
<META NAME="keywords" CONTENT="foros, discusiones, comentarios, conversar, conversaciones, forums, preguntas, preguntar, dudar, dudas, cuestionarios, estudiantes, profesores, alumnos, acad�micos, inform�tica, computaci�n, ciencias, lenguajes, programaci�n, universidades, uls, serena, la serena, escuelas">
<META NAME="description" CONTENT="P�gina donde se muestran todos los temas correspondientes a el foro elegido por el usuario. El usuario puede escoger cualquiera de estos temas y comenzar a incorpor�rse a uno de ellos.">
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD WIDTH="400%" COLSPAN="2">
                        <?PHP
						/*
						 * Script en donde mostramos el listado de temas (en forma paginada) de
						 * un foro ordenados por fecha de env�o.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$foro->temas($_GET['id'], $_GET['pagina']);

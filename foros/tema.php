<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Foros - Tema</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="foros, temas, mensajes, agregar, consultar, enviar, discusiones, comentarios, conversar, forums, preguntar, preguntas, dudar, dudas, cuestionarios, estudiantes, profesores, alumnos, acad�micos, inform�tica, computaci�n, ciencias, lenguajes, programaci�n, universidades, uls, serena, la serena, escuelas">
<META NAME="description" CONTENT="P�gina en donde se muestran los mensajes enviados por los usuarios a un tema espec�fico de un foro.">
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD WIDTH="400%" COLSPAN="2"> 
                        <?PHP
						/*
						 * Script en donde mostramos el listado de mensajes enviados para un tema.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$foro->notas($_GET['id'], $_GET['pagina']);

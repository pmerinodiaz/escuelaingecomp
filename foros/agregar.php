<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Foros - Agregar Tema</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="foros, agregar, consultar, enviar, mensajes, discusiones, comentarios, comentar, conversar, conversaciones, forums, preguntar, preguntas, dudar, dudas, cuestionarios, estudiantes, profesores, alumnos, acad�micos, inform�tica, computaci�n, ciencias, lenguajes, programaci�n, universidades, uls, serena, la serena, escuelas">
<META NAME="description" CONTENT="P�gina en donde se muestra el formulario para que el usuario  pueda agregar un nuevo tema al foro que el usuario eligi� anteriormente.">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			...
			*/
			...
			if ($correcto)
			{
				...
				$foro = new foro($link);
				$foro->tituloAgregarNota(1, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD WIDTH="400%" COLSPAN="2"> 
                        <?PHP
						/*
						 * Script en donde mostramos el formulario para que el usuario pueda agregar
						 * una mensaje al foro que �l escogi�.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$foro->formularioAgregarNota($_GET['id']);

<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Foros - Agregar</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="foros, agregar, temas, consultar, consultas, enviar, mensajes, discusiones, comentarios, conversar, conversaciones, forums, comentarios, preguntar, dudar, dudas, cuestionarios, estudiantes, profesores, alumnos, acad�micos, inform�tica, computaci�n, ciencias, lenguajes, programaci�n, universidades, uls, serena, la serena, escuelas">
<META NAME="description" CONTENT="P�gina en la cual se registra un tema enviado por un usuario al foro elegido por �l mismo.">
...
if (!isset($_POST['nombres']) || !isset($_POST['paterno']) || !isset($_POST['materno']) || !isset($_POST['email']) || !isset($_POST['asunto']) || !isset($_POST['notificacion']) || !isset($_POST['texto']) || !isset($_POST['id']) || !is_string($_POST['nombres']) || !is_string($_POST['paterno']) || !is_string($_POST['materno']) || !is_string($_POST['email']) || !is_string($_POST['asunto']) || !is_string($_POST['notificacion']) || !is_string($_POST['texto']) || !is_numeric($_POST['id']))
	$correcto = false;
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
            <?PHP
			/*
			 * Script en donde creamos el objeto foro o bien el objeto error.
			*/
			...
			if ($correcto)
			{
				...
				// Creamos un objeto foro y mostramos el t�tulo de esta secci�n.
				$foro = new foro($link);
				$foro->tituloAgregarNota(1, $_POST['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD WIDTH="400%" COLSPAN="2"> 
                        <?PHP
						/*
						 * Script en donde registramos en la base de datos el tema enviado por el usuario.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$foro->agregarNota("foro.php?id=" . $_POST['id'] . "&pagina=1", $_POST['nombres'], $_POST['paterno'], $_POST['materno'], $_POST['email'], $_POST['asunto'], $_POST['notificacion'], $_POST['texto'], $_POST['id'], NULL);

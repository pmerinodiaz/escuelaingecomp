...
<META NAME="keywords" CONTENT="intranets, servicios, redes, internas, internos, locales, escuelas, ingenier�as, computaci�n, universidades, uls, la serena, recordar, claves, recordatorios, contrase�as">
<META NAME="description" CONTENT="En esta p�gina se presenta el formulario para que el usuario pueda ingresar su nombre de usuario y nosotros le podemos enviar su clave secreta por correo.">
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
    ...
    <TD WIDTH="350" HEIGHT="158" COLSPAN="2" VALIGN="TOP">
        ...
        <TR> 
          <TD CLASS="descripcion">
						<OL>
              <LI><FONT COLOR="#CC0000"><STRONG>Ingresa tu nombre de usuario.</STRONG></FONT></LI>
  ...
  <TR>
    ...
    <TD WIDTH="340" HEIGHT="76" COLSPAN="2" VALIGN="TOP"> 
      <TABLE WIDTH="70%" BORDER="0" CELLPADDING="0" CELLSPACING="0" BACKGROUND="../librerias/bglogon.gif" MM_NOCONVERT="TRUE">
        ...
        <TR> 
          <TD>
						<FORM ACTION="preguntar.php" METHOD="post" NAME="formulario" onSubmit="return validarFormulario();">
              <TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="0">
                ...
                <TR>
                  <TD COLSPAN="2" ALIGN="CENTER"><INPUT NAME="enviar" TYPE="submit" CLASS="formbutton" ID="enviar" VALUE="Enviar" TITLE="Enviar el nombre de usuario"></TD>
                </TR>
                <TR> 
                  <TD COLSPAN="2" ALIGN="CENTER"><IMG SRC="../librerias/pxblanco.gif" WIDTH="1" HEIGHT="10"></TD>
                </TR>
  ...
  <TR>
    <TD WIDTH="10" HEIGHT="169" VALIGN="TOP"></TD>
    <TD WIDTH="239" HEIGHT="169" VALIGN="TOP"></TD>
    <TD WIDTH="111" HEIGHT="169" VALIGN="TOP"></TD>
    <TD WIDTH="229" HEIGHT="169" VALIGN="TOP"></TD>
    <TD WIDTH="191" HEIGHT="169" VALIGN="TOP"></TD>
  </TR>
  <TR>

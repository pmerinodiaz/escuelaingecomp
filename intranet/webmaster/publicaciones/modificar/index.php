...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="617" HEIGHT="413" ROWSPAN="2" valign="top"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de publicaci�n y se muestran las publicaciones
			...
			*/
			...
			// Abrimos la sesi�n, creamos un objeto publicaci�n y mostramos las publicaciones de
			// la persona.
			$publicacion = new publicacion($link);
			$publicacion->listar($_SESSION["id_persona"], "modificar.php");

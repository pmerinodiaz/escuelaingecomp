...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Webmaster - Modificar Publicaci&oacute;n</TITLE>
...
if (isset($_POST['titulo']) && isset($_POST['tipo_publicacion']) && isset($_POST['anio']) && isset($_POST['en_biblioteca']) && isset($_POST['id_publicacion']) && is_string($_POST['titulo']) && is_numeric($_POST['tipo_publicacion']) && is_numeric($_POST['anio']) && is_numeric($_POST['en_biblioteca']) && is_numeric($_POST['id_publicacion']))
	$correcto = true;
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de publicacion y se actualizan los datos de
			 * la publicaci�n efectuada por la persona.
			*/
			...
			if ($correcto)
			{
				...
				// Creamos un objeto publicaci�n y actualizamos la publicaci�n.
				$publicacion = new publicacion($link);
				
				// Cuando la publicaci�n no es una tesis.
				if ($_POST['tipo_publicacion'] != 2)
					$publicacion->modificar($_POST['id_publicacion'], $_POST['titulo'], $_POST['tipo_publicacion'], $_POST['empresa'], $_POST['anio'], $_POST['en_biblioteca']);
				// Cuando la publicaci�n es una tesis.
				else $publicacion->modificar($_POST['id_publicacion'], $_POST['titulo'], $_POST['tipo_publicacion'], -1, $_POST['anio'], $_POST['en_biblioteca']);

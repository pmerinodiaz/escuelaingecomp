...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de publicaci�n y se muestra el formulario de
			 * ingreso de una nueva publicaci�n.
			*/
			...
			// Abrimos la sesi�n, creamos un publicaci�n y mostramos el formulario para agregar
			// una nueva publicaci�n.
			$publicacion = new publicacion($link);
			$publicacion->formularioAgregar($_SESSION["id_persona"]);

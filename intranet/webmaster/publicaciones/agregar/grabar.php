...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Webmaster - Agregar Publicaci&oacute;n</TITLE>
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de publicaci�n y se graba la nueva
			 * publicaci�n en la base de datos.
			*/
			
			// Cuando los par�metros son correctos.
			if ($correcto)
			{
				...
				// Abrimos la sesi�n, creamos un objeto publicacion y agregamos la publicacion
				// a la base de datos.
			...
			// Cuando los par�metros no son correctos.
			else
			{
				// Librer�as necesarias.

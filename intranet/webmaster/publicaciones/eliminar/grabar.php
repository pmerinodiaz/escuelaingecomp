...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Webmaster - Eliminar Publicaci&oacute;n</TITLE>
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de publicaci�n y se elimina de la base de datos
			...
			*/
			...
			if ($correcto)
			{
				...
				// Abrimos la sesi�n, creamos un objeto publicaci�n y eliminamos la publicaci�n.

...
function validarFormulario()
{
	if(validarCampo(document.formulario.titulo,isAny,false)&&
		 ...
		 validarCampo(document.formulario.imagen,isImage,false)&&
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de noticia y se muestra el formulario de
			 * ingreso de una nueva noticia.
			*/
			...
			$noticia->formularioAgregar($_SESSION["id_persona"]);

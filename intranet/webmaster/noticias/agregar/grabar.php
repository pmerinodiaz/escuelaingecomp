...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Webmaster - Agregar Noticia</TITLE>
...
if (isset($_POST['titulo']) && isset($_POST['tipo_noticia']) && isset($_POST['fecha']) && isset($_POST['sitio_web']) && isset($_POST['descripcion']) && is_string($_POST['titulo']) && is_numeric($_POST['tipo_noticia']) && is_string($_POST['fecha']) && is_string($_POST['sitio_web']) && is_string($_POST['descripcion']))
	$correcto = true;
      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				$noticia->agregar($_SESSION["id_persona"], $_POST['titulo'], $_POST['tipo_noticia'], $_POST['fecha'], $HTTP_POST_FILES['imagen'], $_POST['sitio_web'], $_POST['descripcion']);

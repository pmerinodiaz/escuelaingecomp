...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Webmaster - Eliminar Noticia</TITLE>
      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				$noticia->eliminar($_SESSION["id_persona"], $_POST["id_envio"], $_POST['confirmar']);

...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="617" height="413" valign="top"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de noticia y se muestran todas las
			 * noticias realizadas por la persona que esta autentificada.
			*/
			...
			// Abrimos la sesión, creamos un objeto noticia y listamos las noticias.
			$noticia = new noticia($link);
			$noticia->listar($_SESSION["id_persona"], "eliminar.php");

...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de noticia y se muestran los datos que
			 * tiene una noticia en espec�fico.
			*/
			...
			if ($correcto)
			{
				...
				// Abrimos la sesi�n, creamos un objeto noticia y mostramos la noticia.
				$noticia = new noticia($link);
				$noticia->formularioEliminar($_SESSION["id_persona"], $_GET['id']);

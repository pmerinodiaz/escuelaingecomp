...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Webmaster - Datos Servidor Base de Datos</TITLE>
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR> 
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"><STRONG><SPAN CLASS="contenido">Datos Servidor de Base de Datos</SPAN></STRONG> 
      <TABLE WIDTH="100%" BORDER="1" CELLPADDING="0" CELLSPACING="0" BORDERCOLOR="F1F1F1" BGCOLOR="#FFFFFF">
        <TR> 
          <TD>
              ...
              <TR> 
                <TD WIDTH="21%" CLASS="formlabel">Usuario:</TD>
                <TD WIDTH="79%"><INPUT NAME="usuario" TYPE="text" CLASS="formtextfield" VALUE="u190876680_comp" DISABLED></TD>
              </TR>
              <TR> 
                <TD CLASS="formlabel">Clave:</TD>
                <TD><INPUT NAME="clave" TYPE="text" CLASS="formtextfield" VALUE="masterkey" DISABLED></TD>
              </TR>
              <TR> 
                <TD COLSPAN="2">&nbsp;</TD>
              </TR>

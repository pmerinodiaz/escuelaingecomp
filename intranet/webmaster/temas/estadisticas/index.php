...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Webmaster - Estad&iacute;sticas Temas</TITLE>
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de tema y se muestran las estadísticas
			 * de los temas que han visitado este sitio Web.
			*/
			...
			// Creamos un objeto tema y mostramos las estadísticas.
			$tema = new tema($link);
			$tema->estadisticas();

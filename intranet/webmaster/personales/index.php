...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Webmaster - Antecedentes Personales</TITLE>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			...
			*/
			...
			// Abrimos la sesi�n, creamos un objeto usuario interno y mostramos los antecedentes.
			$usuario_interno = new usuariointerno($link);
			$usuario_interno->mostrarAntecedentes($_SESSION["id_persona"]);

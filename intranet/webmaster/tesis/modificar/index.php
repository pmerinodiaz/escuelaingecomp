...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="617" HEIGHT="413" ROWSPAN="2" valign="top"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de oferta de tesis y se muestran las ofertas
			 * efectuadas por la persona que tiene la sesión abierta.
			*/
			...
			// Abrimos la sesión, creamos un objeto oferta de tesis y mostramos las ofertas de
			// la persona.
			$oferta_tesis = new ofertatesis($link);
			$oferta_tesis->listar($_SESSION["id_persona"], "modificar.php");

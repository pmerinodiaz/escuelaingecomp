...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Webmaster - Modificar Oferta de Tesis</TITLE>
...
if (isset($_POST['titulo']) && isset($_POST['descripcion']) && isset($_POST['id_envio']) && is_string($_POST['titulo']) && is_string($_POST['descripcion']) && is_numeric($_POST['id_envio']))
	$correcto = true;
      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				$oferta_tesis->modificar($_POST['id_envio'], $_POST['titulo'], $_POST['descripcion']);

  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			 ...
			 * de la oferta seleccionada por el usuario.
			*/
			...
			if ($correcto)
			{
				...
				// Abrimos la sesi�n, creamos un objeto oferta de tesis y mostramos los datos de
				// la oferta de tesis.
				$oferta_tesis = new ofertatesis($link);
				$oferta_tesis->formularioModificar($_SESSION["id_persona"], $_GET['id']);

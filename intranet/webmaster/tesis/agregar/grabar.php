...
if (isset($_POST['titulo']) && isset($_POST['descripcion']) && is_string($_POST['titulo']) && is_string($_POST['descripcion']))
	$correcto = true;
      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				$oferta_tesis->agregar($_SESSION["id_persona"], $_POST['titulo'], $_POST['descripcion']);

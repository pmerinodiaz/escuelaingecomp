...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Webmaster - Agregar Oferta de Tesis</TITLE>
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de oferta de tesis y se muestra el formulario
			 * de ingreso de una nueva oferta.
			*/
			...
			// Abrimos la sesión, creamos una oferta de tesis y mostramos el formulario para agregar
			// una nueva oferta de tesis.
			$oferta_tesis = new ofertatesis($link);
			$oferta_tesis->formularioAgregar($_SESSION["id_persona"]);

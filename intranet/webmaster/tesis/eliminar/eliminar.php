...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de oferta de tesis y se muestran los datos
			 * que tiene la oferta en espec�fico.
			*/
			...
			if ($correcto)
			{
				...
				// Abrimos la sesi�n, creamos un objeto oferta de tesis y mostramos la oferta
				// de tesis.
				$oferta_tesis = new ofertatesis($link);
				$oferta_tesis->formularioEliminar($_SESSION["id_persona"], $_GET['id']);

...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Webmaster - Eliminar Oferta de Tesis</TITLE>
      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				$oferta_tesis->eliminar($_POST['id_envio'], $_POST['confirmar']);

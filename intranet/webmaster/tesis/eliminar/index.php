...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="617" height="413" valign="top"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de oferta de tesis y se muestran todas las
			 * ofertas realizadas por la persona que esta autentificada.
			*/
			...
			// Abrimos la sesión, creamos un objeto oferta de tesis y listamos las ofertas.
			$oferta_tesis = new ofertatesis($link);
			$oferta_tesis->listar($_SESSION["id_persona"], "eliminar.php");

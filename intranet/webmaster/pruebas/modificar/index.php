...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="617" height="413" valign="top"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de prueba y se muestran los pruebas enviadas
			 * por el usuario que tiene abierta la sesi�n.
			*/
			...
			// Abrimos la sesi�n, creamos un objeto prueba y mostramos los pruebas del usuario
			// que tiene la sesi�n abierta.
			$prueba = new prueba($link);
			$prueba->listar($_SESSION["id_persona"], "modificar.php");

...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Webmaster - Modificar Prueba</TITLE>
			...
			*/
			...
			if ($correcto)
			{
				...
				if ($_POST['archivo_internet'] == 1)
					$prueba->modificar($id_persona, $_POST['id_prueba'], $_POST['asignatura'], $_POST['formato'], $_POST['semestre'], $_POST['tipo_prueba'], $_POST['numero'], $_POST['anio'], true, $_POST['url_archivo']);
				
				// Cuando el archivo no est� en Internet.
				else $prueba->modificar($id_persona, $_POST['id_prueba'], $_POST['asignatura'], $_POST['formato'], $_POST['semestre'], $_POST['tipo_prueba'], $_POST['numero'], $_POST['anio'], false, $HTTP_POST_FILES['src_archivo']);

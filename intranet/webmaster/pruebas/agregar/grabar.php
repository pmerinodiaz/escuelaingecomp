...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Webmaster - Agregar Prueba</TITLE>
...
if (isset($_POST['asignatura']) && isset($_POST['numero']) && isset($_POST['anio']) && isset($_POST['formato']) && isset($_POST['semestre']) && isset($_POST['tipo_prueba']) && isset($_POST['archivo_internet']) && is_numeric($_POST['asignatura']) && is_numeric($_POST['numero']) && is_numeric($_POST['anio']) && is_numeric($_POST['formato']) && is_numeric($_POST['semestre']) && is_numeric($_POST['tipo_prueba']) && is_numeric($_POST['archivo_internet']))
	$correcto = true;
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de prueba y se graba la nueva prueba
			 * en la base de datos.
			*/
			...
			if ($correcto)
			{
				...
				// Abrimos la sesi�n, creamos un objeto prueba y agregamos la prueba.
				$prueba = new prueba($link);
				
				// Cuando el archivo ya est� en Internet.
				if ($_POST['archivo_internet'] == 1)
					$prueba->agregar($_POST['asignatura'], $_SESSION["id_persona"], $_POST['formato'], $_POST['semestre'], $_POST['tipo_prueba'], $_POST['numero'], $_POST['anio'], true, $_POST['url_archivo']);
				
				// Cuando el archivo no est� en Internet.
				else $prueba->agregar($_POST['asignatura'], $_SESSION["id_persona"], $_POST['formato'], $_POST['semestre'], $_POST['tipo_prueba'], $_POST['numero'], $_POST['anio'], false, $HTTP_POST_FILES['src_archivo']);

...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de oferta de servicio y se muestran los datos que
			 * tiene una oferta de servicio en espec�fico.
			*/
			...
			if ($correcto)
			{
				...
				$servicio->formularioEliminar($_SESSION["id_persona"], $_GET['id']);

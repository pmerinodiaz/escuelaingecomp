...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Webmaster - Eliminar Publicaci&oacute;n Biblioteca IC</TITLE>
...
if (isset($_POST['confirmar']) && isset($_POST['id_publicacion']) && isset($_POST['id_persona']) && is_numeric($_POST['confirmar']) && is_numeric($_POST['id_publicacion']) && is_numeric($_POST['id_persona']))
	$correcto = true;
      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				$publicacion->eliminarBiblioteca($_POST['id_persona'], $_POST['id_publicacion'], $_POST['confirmar']);

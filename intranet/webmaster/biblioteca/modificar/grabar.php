...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Webmaster - Modificar Publicaci&oacute;n Biblioteca IC</TITLE>
...
if (isset($_POST['titulo']) && isset($_POST['tipo_publicacion']) && isset($_POST['anio']) && isset($_POST['nombres']) && isset($_POST['paterno']) && isset($_POST['materno']) && isset($_POST['email']) && isset($_POST['id_publicacion']) && isset($_POST['id_persona']) && is_string($_POST['titulo']) && is_numeric($_POST['tipo_publicacion']) && is_numeric($_POST['anio']) && is_string($_POST['nombres']) && is_string($_POST['paterno']) && is_string($_POST['materno']) && is_string($_POST['email']) && is_numeric($_POST['id_publicacion']) && is_numeric($_POST['id_persona']))
	$correcto = true;
			...
			*/
			...
			if ($correcto)
			{
				...
				if ($_POST['tipo_publicacion'] != 2)
					$publicacion->modificarBiblioteca($_POST['id_publicacion'], $_POST['titulo'], $_POST['tipo_publicacion'], $_POST['empresa'], $_POST['anio'], $_POST['id_persona'], $_POST['nombres'], $_POST['paterno'], $_POST['materno'], $_POST['email']);
				// Cuando la publicación es tesis.
				else $publicacion->modificarBiblioteca($_POST['id_publicacion'], $_POST['titulo'], $_POST['tipo_publicacion'], -1, $_POST['anio'], $_POST['id_persona'], $_POST['nombres'], $_POST['paterno'], $_POST['materno'], $_POST['email']);

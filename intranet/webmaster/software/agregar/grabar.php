      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				// Abrimos la sesi�n, creamos un objeto software y agregamos el software.
				...
				// Cuando el archivo no est� a�n en Internet.
				else $software->agregar(1, $_POST['sistema_operativo'], $_POST['idioma'], $_POST['formato'], $_POST['licencia'], $_SESSION["id_persona"], $_POST['nombre'], $_POST['descripcion'], $_POST['version'], false, $HTTP_POST_FILES['src_archivo']);

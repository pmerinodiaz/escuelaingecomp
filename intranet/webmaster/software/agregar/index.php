...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Webmaster - Agregar Software</TITLE>
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de software y se muestra el formulario de
			 * ingreso de un nuevo software.
			*/
			...
			// Abrimos la sesi�n, creamos un objeto software y mostramos el formulario para agregar
			// un nuevo software.
			$software = new software($link);
			$software->formularioAgregar($_SESSION["id_persona"]);

...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Webmaster - Modificar Software</TITLE>
...
{
	if(validarCampo(document.formulario.nombre,isAny,false)&&
		 validarCampo(document.formulario.version,isAny,false))
	{
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de la clase software y se muestran los datos
			 * del software que fue elegido por el usuario para modificarlos.
			*/
			...
			if ($correcto)
			{
				...
				// Abrimos la sesi�n, creamos un objeto software y mostramos los datos del software.
				$software = new software($link);
				$software->formularioModificar($_SESSION["id_persona"], $_GET['id']);

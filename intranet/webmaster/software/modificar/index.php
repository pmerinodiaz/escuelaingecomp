...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="617" height="413" valign="top"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de Software y se muestran los software
			 * enviados por el usuario que tiene abierta la sesi�n.
			*/
			...
			// Abrimos la sesi�n, creamos un objeto software y mostramos los software del usuario
			// que tiene la sesi�n abierta.
			$software = new software($link);
			$software->listar($_SESSION["id_persona"], 1, "modificar.php");

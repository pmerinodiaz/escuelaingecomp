      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				else $software->modificar($_SESSION["id_persona"], $_POST['id_utilidad'], $_POST['nombre'], $_POST['version'], $_POST['sistema_operativo'], $_POST['licencia'], $_POST['idioma'], $_POST['formato'], $_POST['licencia'], false, $_POST['src_archivo'], $_POST['descripcion']);

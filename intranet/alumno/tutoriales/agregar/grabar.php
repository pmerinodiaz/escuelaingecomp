...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Alumno - Agregar Tutorial</TITLE>
			...
			*/
			...
			if ($correcto)
			{
				...
				if ($_POST['archivo_internet'] == 1)
					$tutorial->agregar(1, $_POST['apartado'], $_POST['idioma'], $_POST['formato'], $_SESSION["id_persona"], $_POST['titulo'], $_POST['descripcion'], true, $_POST['url_archivo']);

...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Alumno - Eliminar Oferta de Servicio</TITLE>
      ...
      <?PHP
			...
			*/
			...
			{			
				...
				$oferta_servicio->eliminar($_POST['id_envio'], $_POST['confirmar']);

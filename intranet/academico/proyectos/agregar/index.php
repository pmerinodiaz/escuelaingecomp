...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de proyecto y se muestra el formulario de
			...
			*/
			...
			// Creamos un proyecto y mostramos el formulario para agregar un nuevo proyecto.
			$proyecto = new proyecto($link);
			$proyecto->formularioAgregar();

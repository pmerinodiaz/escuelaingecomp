...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="617" HEIGHT="413" ROWSPAN="2" valign="top"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de proyecto y se muestran todos los proyectos
			 * de investigación que tiene la Escuela Ingeniería en Computación.
			*/
			...
			// Creamos un objeto proyecto y mostramos los proyectos de la Escuela.
			$proyecto = new proyecto($link);
			$proyecto->listar("modificar.php");

...
function validarFormulario()
{
	if(validarCampo(document.formulario.titulo,isAny,false)&&
		 validarCampo(document.formulario.inicio,isIntegerUnsigned,false)&&
		 validarCampo(document.formulario.fin,isIntegerUnsigned,false))
		return true;
	return false;
}
//-->
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de royecto y se muestran los datos del
			 * proyecto de investigaci�n seleccionado por el usuario.
			*/
			...
			if ($correcto)
			{
				...
				// Creamos un objeto proyecto y mostramos los datos del proyecto.
				$proyecto = new proyecto($link);
				$proyecto->formularioModificar($_GET['id']);

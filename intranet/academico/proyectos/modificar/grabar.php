...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Acad&eacute;mico - Modificar Proyecto</TITLE>
...
if (isset($_POST['titulo']) && isset($_POST['tipo_proyecto']) && isset($_POST['financiante']) && isset($_POST['patrocinante']) && isset($_POST['inicio']) && isset($_POST['fin']) && isset($_POST['id_proyecto']) && is_string($_POST['titulo']) && is_numeric($_POST['tipo_proyecto']) && is_numeric($_POST['financiante']) && is_numeric($_POST['patrocinante']) && is_numeric($_POST['inicio']) && is_numeric($_POST['fin']) && is_numeric($_POST['id_proyecto']))
	$correcto = true;
      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				$proyecto->modificar($_POST['id_proyecto'], $_POST['titulo'], $_POST['tipo_proyecto'], $_POST['financiante'], $_POST['patrocinante'], $_POST['inicio'], $_POST['fin']);

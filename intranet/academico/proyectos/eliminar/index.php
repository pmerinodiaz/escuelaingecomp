...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="617" height="413" valign="top"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de proyecto y se muestran todos los
			 * proyectos de investigación realizados en la Escuela.
			*/
			...
			// Creamos un objeto proyecto y listamos los proyectos de investigación.
			$proyecto = new proyecto($link);
			$proyecto->listar("eliminar.php");

...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Acad&eacute;mico - Eliminar Proyecto</TITLE>
...
if (isset($_POST['confirmar']) && isset($_POST['id_proyecto']) && is_numeric($_POST['confirmar']) && is_numeric($_POST['id_proyecto']))
	$correcto = true;
      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				$proyecto->eliminar($_POST['id_proyecto'], $_POST['confirmar']);

...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Acad&eacute;mico - Eliminar Solicitud de Servicio</TITLE>
...
if (isset($_POST['confirmar']) && isset($_POST['id_envio']) && is_numeric($_POST['confirmar']) && is_numeric($_POST['id_envio']))
	$correcto = true;
      ...
      <?PHP
			...
			*/
			...
			{			
				...
				$solicitud_servicio->eliminar($_POST['id_envio'], $_SESSION["id_persona"], $_POST['confirmar']);

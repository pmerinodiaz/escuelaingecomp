...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="617" height="413" valign="top"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de solicitud de servicio y se muestran todas
			 * las solicitudes de servicios realizadas por la persona que esta autentificada.
			*/
			...
			// Abrimos la sesión, creamos un objeto servicio y listamos las solicitudes de
			// servicios.
			$solicitud_servicio = new solicitudservicio($link);
			$solicitud_servicio->listar($_SESSION["id_persona"], "eliminar.php");

...
function setearFoco()
{
	if(document.formulario!=null)
		document.formulario.aceptar.focus();
}
//-->
</SCRIPT>
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			 ...
			 * que tiene una solicitud de servicio en espec�fico.
			*/
			...
			if ($correcto)
			{
				...
				// Abrimos la sesi�n, creamos un objeto servicio y mostramos la oferta.
				$solicitud_servicio = new solicitudservicio($link);
				$solicitud_servicio->formularioEliminar($_SESSION["id_persona"], $_GET['id']);

...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="617" height="413" valign="top"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de solicitud de servicio y se muestran
			 * las solicitud de servicios efectuadas por una persona.
			*/
			...
			// Abrimos la sesión, creamos un objeto servicio y mostramos las solicitudes de
			// servicios de la persona.
			$solicitud_servicio = new solicitudservicio($link);
			$solicitud_servicio->listar($_SESSION["id_persona"], "modificar.php");

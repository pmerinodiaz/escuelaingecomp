...
function validarFormulario()
{
	if(validarCampo(document.formulario.titulo,isAny,false)&&
		 validarCampo(document.formulario.inicio,isDate,false)&&
		 validarCampo(document.formulario.termino,isDate,false)&&
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de solicitud de servicio y se muestra el
			 * formulario de ingreso de una nueva solicitud.
			*/
			...
			// Abrimos la sesión, creamos un objeto servicio y mostramos el formulario para agregar
			// una solicitud de servicio.
			$solicitud_servicio = new solicitudservicio($link);
			$solicitud_servicio->formularioAgregar($_SESSION["id_persona"]);

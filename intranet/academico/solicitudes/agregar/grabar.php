...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Acad&eacute;mico - Agregar Solicitud de Servicio</TITLE>
...
if (isset($_POST['titulo']) && isset($_POST['empresa']) && isset($_POST['inicio']) && isset($_POST['termino']) && isset($_POST['tipo_servicio']) && isset($_POST['descripcion']) && is_string($_POST['titulo']) && is_numeric($_POST['empresa']) && is_string($_POST['inicio']) && is_string($_POST['termino']) && is_numeric($_POST['tipo_servicio']) && is_string($_POST['descripcion']))
	$correcto = true;
      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				$solicitud_servicio->agregar($_POST['titulo'], $_POST['empresa'], $_SESSION["id_persona"], $_POST['inicio'], $_POST['termino'], $_POST['tipo_servicio'], $_POST['descripcion']);

...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Acad&eacute;mico - Eliminar Foro</TITLE>
...
if (isset($_POST['confirmar']) && isset($_POST['id_foro']))
	$correcto = true;
      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				$foro = new foro($link);
				$foro->eliminar($_SESSION["id_persona"], $_POST['id_foro'], $_POST['confirmar']);

...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Acad&eacute;mico - Agregar Foro</TITLE>
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de foro y se muestra el formulario de
			 * ingreso para un nuevo foro.
			*/
			...
			// Abrimos la sesión, creamos un objeto foro y mostramos el formulario para agregar
			// un nuevo foro.
			$foro = new foro($link);
			$foro->formularioAgregar($_SESSION["id_persona"]);

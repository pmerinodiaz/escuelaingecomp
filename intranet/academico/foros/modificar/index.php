...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    ...
    <td width="617" HEIGHT="413" ROWSPAN="2" valign="top"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de foro y se muestran los foros que ha
			 * creado la persona con la sesión abierta.
			*/
			...
			// Abrimos la sesión, creamos un objeto foro y mostramos los foros de la persona.
			$foro = new foro($link);
			$foro->listar($_SESSION["id_persona"], "modificar.php");

...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de foro y se muestran los datos del
			 * foro creado por el usuario.
			*/
			...
			if ($correcto)
			{
				...
				// Creamos un objeto foro y mostramos los datos del foro.
				$foro = new foro($link);
				$foro->formularioModificar($_SESSION["id_persona"], $_GET['id']);

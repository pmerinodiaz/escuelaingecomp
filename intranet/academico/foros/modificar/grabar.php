...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Acad&eacute;mico - Modificar Foro</TITLE>
...
if (isset($_POST['id_foro']) && isset($_POST['nombre']) && is_numeric($_POST['id_foro']) && is_string($_POST['nombre']))
	$correcto = true;
      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				$foro = new foro($link);
				$foro->modificar($_SESSION["id_persona"], $_POST['id_foro'], $_POST['nombre']);

...
{
	if(validarCampo(document.formulario.grado,isAny,false))
	{
		if(document.formulario.cambio.checked)
		{
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de académico y se muestran los antecedentes docentes
			 * que éste tiene.
			*/
			...
			// Abrimos la sesión, creamos un objeto academico y mostramos los antecedentes docentes.
			$academico = new academico($link);
			$academico->formularioDocentes($_SESSION["id_persona"]);

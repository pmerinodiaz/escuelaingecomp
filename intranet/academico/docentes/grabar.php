...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde creamos un objeto académico o bien un objeto error. Luego modificamos
			 * los datos del académico o mostramos los mensajes de error.
			*/
			...
			if ($correcto)
			{
				...
				// Capturamos la variable de sesión, creamos un objeto académico y actualizamos los datos.

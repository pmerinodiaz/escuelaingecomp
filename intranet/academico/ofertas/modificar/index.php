...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="617" height="413" valign="top"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de oferta de servicio y se muestran
			 * las ofertas de servicios efectuadas por una persona.
			*/
			...
			// Abrimos la sesión, creamos un objeto servicio y mostramos las ofertas de
			// servicios de la persona.
			$servicio = new ofertaservicio($link);
			$servicio->listar($_SESSION["id_persona"], "modificar.php");

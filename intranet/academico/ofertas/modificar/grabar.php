...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Acad&eacute;mico - Modificar Oferta de Servicio</TITLE>
...
if (isset($_POST['titulo']) && isset($_POST['inicio']) && isset($_POST['termino']) && isset($_POST['tipo_servicio']) && isset($_POST['descripcion']) && isset($_POST['id_envio']) && is_string($_POST['titulo']) && is_string($_POST['inicio']) && is_string($_POST['termino']) && is_numeric($_POST['tipo_servicio']) && is_string($_POST['descripcion']) && is_numeric($_POST['id_envio']))
	$correcto = true;
      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				// Abrimos la sesión, creamos un objeto servicio y actualizamos la oferta.
				$servicio = new ofertaservicio($link);
				$servicio->modificar($_SESSION["id_persona"], $_POST['titulo'], $_POST['inicio'], $_POST['termino'], $_POST['tipo_servicio'], $_POST['descripcion'], $_POST['id_envio']);

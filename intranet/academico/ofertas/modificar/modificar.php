...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de oferta de servicio y se muestran los datos
			 * de una oferta de servicio.
			*/
			...
			if ($correcto)
			{
				...
				// Abrimos la sesi�n, creamos un objeto servicio y agregamos la oferta.
				$oferta_servicio = new ofertaservicio($link);
				$oferta_servicio->formularioModificar($_SESSION["id_persona"], $_GET['id']);

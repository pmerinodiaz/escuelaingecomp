...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Acad&eacute;mico - Agregar Oferta de Servicio</TITLE>
...
if (isset($_POST['titulo']) && isset($_POST['inicio']) && isset($_POST['termino']) && isset($_POST['descripcion']) && is_string($_POST['titulo']) && is_string($_POST['inicio']) && is_string($_POST['termino']) && is_string($_POST['descripcion']))
	$correcto = true;
      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				$oferta_servicio->agregar($_POST['titulo'], $_SESSION["id_persona"], $_POST['inicio'], $_POST['termino'], $_POST['tipo_servicio'], $_POST['descripcion']);

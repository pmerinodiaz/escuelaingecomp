...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de oferta de servicio y se muestra el
			 * formulario de ingreso de una nueva oferta.
			*/
			...
			$oferta_servicio->formularioAgregar($_SESSION["id_persona"]);

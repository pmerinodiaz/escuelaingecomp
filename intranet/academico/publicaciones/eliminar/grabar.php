...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Acad&eacute;mico - Eliminar Publicaci&oacute;n</TITLE>
...
if (isset($_POST['confirmar']) && isset($_POST['id_publicacion']) && is_numeric($_POST['confirmar']) && is_numeric($_POST['id_publicacion']))
	$correcto = true;
      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				// Abrimos la sesión, creamos un objeto publicación y eliminamos la publicación.
				$publicacion = new publicacion($link);
				$publicacion->eliminar($_POST['id_publicacion'], $_SESSION["id_persona"], $_POST['confirmar']);

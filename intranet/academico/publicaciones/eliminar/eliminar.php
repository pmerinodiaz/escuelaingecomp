...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de publicaci�n y se muestran los datos que
			 * tiene la publicaci�n en espec�fico.
			*/
			...
			if ($correcto)
			{
				...
				// Abrimos la sesi�n, creamos un objeto publicaci�n y mostramos la publicaci�n.
				$publicacion = new publicacion($link);
				$publicacion->formularioEliminar($_SESSION["id_persona"], $_GET['id']);

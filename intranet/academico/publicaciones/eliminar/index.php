...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="617" height="413" valign="top"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de publicación y se muestran todas las
			 * publicaciones realizadas por la persona que esta autentificada.
			*/
			...
			// Abrimos la sesión, creamos un objeto publicacion y listamos las publicaciones.
			$publicacion = new publicacion($link);
			$publicacion->listar($_SESSION["id_persona"], "eliminar.php");

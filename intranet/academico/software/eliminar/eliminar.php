...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de la clase software y se muestran los datos del
			 * software que fue elegido por el usuario para eliminarse.
			*/
			...
			if ($correcto)
			{
				...
				$software->formularioEliminar($_SESSION["id_persona"], $_GET['id']);

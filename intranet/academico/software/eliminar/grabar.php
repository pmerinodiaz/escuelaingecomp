...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Acad&eacute;mico - Eliminar Software</TITLE>
      ...
      <?PHP
			...
			*/
			...
			if ($correcto)
			{
				...
				$software->eliminar($_SESSION["id_persona"], $_POST['id_utilidad'], $_POST['confirmar']);

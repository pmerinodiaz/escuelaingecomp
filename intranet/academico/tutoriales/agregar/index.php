...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="500" HEIGHT="413" VALIGN="TOP"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de tutorial y se muestra el formulario de ingreso
			 * para un nuevo tutorial.
			*/
			...
			// Abrimos la sesión, creamos un objeto tutorial y mostramos el formulario para agregar
			// un nuevo software.
			$tutorial = new tutorial($link);
			$tutorial->formularioAgregar($_SESSION["id_persona"]);

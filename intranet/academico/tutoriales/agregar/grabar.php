...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Acad&eacute;mico - Agregar Tutorial</TITLE>
...
if (isset($_POST['titulo']) && isset($_POST['apartado']) && isset($_POST['idioma']) && isset($_POST['formato']) && isset($_POST['archivo_internet']) && isset($_POST['descripcion']) && is_string($_POST['titulo']) && is_numeric($_POST['apartado']) && is_numeric($_POST['idioma']) && is_numeric($_POST['formato']) && is_numeric($_POST['archivo_internet']) && is_string($_POST['descripcion']))
	$correcto = true;
			...
			*/
			...
			if ($correcto)
			{
				...
				if ($_POST['archivo_internet'] == 1)
					$tutorial->agregar(1, $_POST['apartado'], $_POST['idioma'], $_POST['formato'], $id_persona, $_POST['titulo'], $_POST['descripcion'], true, $_POST['url_archivo']);
				// Cuando el archivo no está en Internet.
				else $tutorial->agregar(1, $_POST['apartado'], $_POST['idioma'], $_POST['formato'], $_SESSION["id_persona"], $_POST['titulo'], $_POST['descripcion'], false, $HTTP_POST_FILES['src_archivo']);

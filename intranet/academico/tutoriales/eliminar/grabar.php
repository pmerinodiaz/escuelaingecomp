...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Acad&eacute;mico - Eliminar Tutorial</TITLE>
...
if (isset($_POST['id_utilidad']) && isset($_POST['confirmar']) && is_numeric($_POST['id_utilidad']) && is_numeric($_POST['confirmar']))
	$correcto = true;
// Cuando los parámetros son válidos.
else $correcto = false;
?>
      ...
      <?PHP
			...
			*/
			...
			{			
				...
				$tutorial->eliminar($_SESSION["id_persona"], $_POST['id_utilidad'], 1, $_POST['confirmar']);

...
<HTML>
<HEAD>
<TITLE>INTR@NET Escuela Ingenier&iacute;a en Computaci&oacute;n - Acad&eacute;mico - Modificar Tutorial</TITLE>
...
if (isset($_POST['titulo']) && isset($_POST['apartado']) && isset($_POST['idioma']) && isset($_POST['formato']) && isset($_POST['archivo_internet']) && isset($_POST['descripcion']) && isset($_POST['id_utilidad']) && is_string($_POST['titulo']) && is_numeric($_POST['apartado']) && is_numeric($_POST['idioma']) && is_numeric($_POST['formato']) && is_numeric($_POST['archivo_internet']) && is_string($_POST['descripcion']) && is_numeric($_POST['id_utilidad']))
	$correcto = true;
			...
			*/
			...
			{			
				...
				if ($_POST['archivo_internet'] == 1)
					$tutorial->modificar($_SESSION["id_persona"], $_POST['id_utilidad'], $_POST['titulo'], $_POST['apartado'], $_POST['idioma'], $_POST['formato'], true, $_POST['url_archivo'], $_POST['descripcion']);
				
				// Cuando el archivo no está en Internet.
				else $tutorial->modificar($_SESSION["id_persona"], $_POST['id_utilidad'], $_POST['titulo'], $_POST['apartado'], $_POST['idioma'], $_POST['formato'], false, $HTTP_POST_FILES['src_archivo'], $_POST['descripcion']);

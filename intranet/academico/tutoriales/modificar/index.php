...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="617" height="413" valign="top"> 
      <?PHP
			/*
			 * Script en donde se crea un objeto de tutorial y se muestran los tutoriales
			 * enviados por el usuario que tiene abierta la sesión.
			*/
			...
			// Abrimos la sesión, creamos un objeto tutorial y mostramos los tutoriales del usuario
			// que tiene la sesión abierta.
			$tutorial = new tutorial($link);
			$tutorial->listar($_SESSION["id_persona"], 1, "modificar.php");

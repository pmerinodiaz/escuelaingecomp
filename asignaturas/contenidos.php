<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Asignaturas - Contenidos</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="asignaturas, cursos, planes, estudios, docencias, pre-grados, pregrados, programas, estudios, clases, mallas, curriculares, contenidos, cap�tulos, ramos">
<META NAME="description" CONTENT="P�gina din�mica que muestra informaci�n de los contenidos de la asignatura elegida por el usuario.">
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			...
			*/
			...
			if ($correcto)
			{
				...
				$asignatura->mostrarTitulo(3, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
			<?PHP
			/*
			 * Script en donde mostramos la tabla con los contenidos de la asignatura.
			*/
			
			// Cuando los par�metros son v�lidos.
			if ($correcto)
			{
				$asignatura->contenidos($_GET['id']);

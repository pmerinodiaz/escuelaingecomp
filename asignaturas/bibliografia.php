<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Asignaturas - Bibliograf&iacute;a</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="asignaturas, cursos, planes, estudios, docencias, pre-grados, pregrados, programas, clases, mallas, curriculares, bibliograf�as, libros, publicaciones, recomendados, recomendaciones, literaturas, ramos">
<META NAME="description" CONTENT="P�gina en donde se muestra el listado de libros recomendados como bibliograf�a de la asignatura elegida por el usuario.">
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			<?PHP
			/*
			 * Script en donde creamos el objeto asignatura o bien el objeto error.
			*/
			...
			if ($correcto)
			{
				...
				// Creamos un objeto asignatura y mostramos el t�tulo de esta secci�n.
				$asignatura = new asignatura($link);
				$asignatura->mostrarTitulo(4, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
            <?PHP
			/*
			 * Script en donde mostramos la bibliograf�a de la asignatura.
			*/
			
			// Cuando los par�metros son v�lidos.
			if ($correcto)
			{
				$asignatura->bibliografia($_GET['id']);

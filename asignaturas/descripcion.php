<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Asignaturas - Descripci&oacute;n</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="asignaturas, descripciones, cursos, planes, estudios, docencias, pre-grados, pregrados, programas, clases, mallas, curriculares, descripciones, ramos">
<META NAME="description" CONTENT="P�gina donde se muestra la descripci�n completa de la asignatura elegida por el usuario.">
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			...
			*/
			...
			if ($correcto)
			{
				...
				$asignatura->mostrarTitulo(1, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
			<?PHP
			/*
			 * Script en donde mostramos la tabla con la descripci�n de la asignatura
			*/
			
			// Cuando los par�metros son v�lidos.
			if ($correcto)
			{
				$asignatura->descripcion($_GET['id']);

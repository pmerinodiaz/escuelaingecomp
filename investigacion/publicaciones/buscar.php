<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Investigaci&oacute;n - Publicaciones - B&uacute;squeda</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="b�squedas, buscadores, motores, publicaciones, libros, acad�micos, profesores, investigaciones, ciencias, cient�ficos, inform�tica, computaci�n, sistemas, proyectos, trabajos, tecnolog�as">
<META NAME="description" CONTENT="En esta p�gina se muestran las publicaciones obtenidas de la b�squeda de publicaciones creadas por gente de la Escuela Ingenier�a en Computaci�n. Se busca coincidencias de la palabra ingresada por el usuario con el t�tulo de la publicaci�n o bien con el nombre del autor.">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			if ($correcto)
			{
				...
				$publicacion->tituloBusquedaInternas();
			}
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
						<?PHP
						/*
						 * Script en donde se muestran el listado de publicaciones (en forma paginada)
						 * que se han llevados a cabo en la Escuela IC, encontrados por el buscador de proyectos.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$publicacion->buscarInternas($_GET['palabra'], $_GET['pagina']);

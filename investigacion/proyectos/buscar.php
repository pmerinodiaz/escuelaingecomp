<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Investigaci&oacute;n - Proyectos - B&uacute;squeda</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="b�squedas, buscadores, motores, investigaciones, ciencias, cient�ficos, inform�tica, computaci�n, sistemas, proyectos, trabajos, tecnolog�as, publicaciones, libros, acad�micos, profesores, colegiados">
<META NAME="description" CONTENT="P�gina que muestra los proyectos resultantes de la b�squeda de proyectos realizada por el usuario. Se buscan coincidencias de la palabra ingresada con el t�tulo del proyecto o bien con la empresa que lo financia o patrocina.">
...
<?PHP
/**
 * Script en donde se verifica que vengan todos los par�metros en la URL.
*/

// Cuando los par�metros son v�lidos.
if (isset($_GET['palabra']) && isset($_GET['pagina']) && $_GET['palabra'] != NULL && $_GET['pagina'] != NULL && is_string($_GET['palabra']) && is_numeric($_GET['pagina']))
	$correcto = true;
else $correcto = false;
?>
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			<?PHP
			/*
			 * Script en donde creamos el objeto proyecto o bien el objeto error.
			*/
			...
			if ($correcto)
			{
				...
				include("../../librerias/proyecto.php");
				
				// Creamos un objeto conexi�n y nos conectamos a la base de datos.
				$conexion = new conexion();
				$link = $conexion->conectar();
				
				// Creamos un objeto proyecto y mostramos el t�tulo de esta secci�n.
				$proyecto = new proyecto($link);
				$proyecto->tituloBusqueda();
			}
    ...
    <TD WIDTH="154" HEIGHT="540" ROWSPAN="2" VALIGN="TOP" BACKGROUND="../../librerias/bgmenu.gif">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				...
				<TR> 
					<TD BACKGROUND="../../librerias/bgbox.gif" CLASS="tema"><IMG SRC="../../librerias/awtema.gif" WIDTH="18" HEIGHT="10" BORDER="0">Proyectos</TD>
				</TR>
				<TR> 
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde se muestran el listado de proyectos (en forma paginada) que
						 * se han llevados a cabo en la Escuela IC, encontrados por el buscador de proyectos.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$proyecto->buscar($_GET['palabra'], $_GET['pagina']);

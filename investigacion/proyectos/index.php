<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Investigaci&oacute;n - Proyectos</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="investigaciones, ciencias, cient�ficos, inform�tica, computaci�n, sistemas, proyectos, trabajos, tecnolog�as, publicaciones, libros, acad�micos, profesores, colegiados">
<META NAME="description" CONTENT="P�gina en donde se visualizan todos los proyectos de investigaci�n que se han realizado en la Escuela Ingenier�a en Computaci�n de la Universidad de La Serena.">
...
<?PHP
/*
 * Script en donde incrementamos el n�mero de visitas del tema 'Proyectos'.
*/
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde se muestran todos los proyectos que se han llevados a cabo
						 * en la Escuela IC. Para esto se usa un objeto de la clase Proyecto.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$proyecto->mostrar($_GET['pagina']);

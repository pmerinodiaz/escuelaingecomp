<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Noticias - Universidad</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="noticias, escuelas, ingenier�as, computaci�n, universidad, serena, uls, la serena, novedades, tecnolog�as, acontecimientos, �ltimas, recientes, acontecer, noticioso, ciencias, nuevas">
<META NAME="description" CONTENT="En esta p�gina se publican tanto las noticias relacionadas a la Universidad de La Serena, como las de nuestra Escuela Inigenier�a en Computaci�n.">
...
<?PHP
/*
 * Script en donde incrementamos el n�mero de visitas del tema 'Noticias de la Universidad'.
*/
    ...
    <td width="460" height="480" colspan="4" valign="top">
        ...
        <tr> 
          <td> 
                        <?PHP
						/*
						 * Script que muestra en forma paginada las noticias sobre la Universidad.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$noticia->mostrar(1, $_GET['pagina']);

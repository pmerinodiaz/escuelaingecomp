<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Noticias - Universidad - B&uacute;squeda</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="noticias, b�squedas, buscadores, motores, escuelas, ingenier�as, computaci�n, novedades, tecnolog�as, universidades, serena, uls, la serena, acontecimientos, �ltimas, recientes, acontecer, noticioso, ciencias">
<META NAME="description" CONTENT="P�gina donde se muestran las noticias de la Universidad de La Serena resultantes de la b�squeda de noticias. Se muestran las noticias que coinciden en el t�tulo o la descripci�n con la palabra ingresada por el usuario.">
    ...
    <td width="460" height="480" colspan="4" valign="top">
        ...
        <tr> 
          <td> 
                        <?PHP
						/*
						 * Script que muestra el listado de noticias de la Universidad (en forma paginada)
						...
						*/
						...
						if ($correcto)
						{
							$noticia->buscar(1, $_GET['palabra'], $_GET['pagina']);

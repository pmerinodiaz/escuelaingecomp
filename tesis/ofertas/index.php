<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Tesis - Ofertas</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="tesis, t�tulos, memorias, ofertas, temas, reglamentos, cient�ficos, empresas, inform�tica, computaci�n, historiales, ingenier�as, memorias, la serena, universidad, uls, profesores, acad�micos">
<META NAME="description" CONTENT="En esta p�gina se muestra informaci�n sobre las ofertas de tesis propuestas por los profesores de la Escuela a los alumnos de la carrera Ingenier�a en Computaci�n de la Universidad de La Serena.">
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
            <?PHP
			/*
			 * Script en donde creamos el objeto oferta de tesis o bien el objeto error.
			*/
			...
			if ($correcto)
			{
				...
				// Creamos un objeto oferta de tesis y mostramos el t�tulo de esta secci�n.
				$tesis = new ofertatesis($link);
				$tesis->mostrarTitulo();
			}
			// Cuando los par�metros no son v�lidos.
			else
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde se listan todas las ofertas de tesis emitidas por los
						 * profesores de la Escuela Ingenier�a en Computaci�n.
						*/

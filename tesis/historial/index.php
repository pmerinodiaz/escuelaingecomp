<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Tesis - Historial</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="tesis, t�tulos, memorias, historiales, recopilaciones, reglamentos, cient�ficos, ofertas, empresas, inform�tica, computaci�n, ingenier�as, memorias, profesores, acad�micos">
<META NAME="description" CONTENT="En esta secci�n se muestran el historial de tesis de que dispone la Escuela. Es decir, todas las tesis que han sido efectuadas por ex-alumnos de la carrera ingenier�a en computaci�n de la Universidad de La Serena.">
...
<?PHP
/*
 * Script en donde incrementamos el n�mero de visitas del tema 'Ofertas de Tesis'.
*/
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
            <?PHP
			/*
			 * Script en donde creamos el objeto tesis o bien el objeto error.
			*/
			...
			{
				// Librer�as necesarias.
				include("../../librerias/tesis.php");
				
				// Creamos un objeto tesis y mostramos el t�tulo de esta secci�n.
				$tesis = new tesis($link);
				$tesis->mostrarTitulo();
			}
			// Cuando los par�metros no son v�lidos.
			else
    ...
    <TD WIDTH="154" HEIGHT="540" ROWSPAN="2" VALIGN="TOP" BACKGROUND="../../librerias/bgmenu.gif">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				...
				<TR> 
					<TD BACKGROUND="../../librerias/bgbox.gif" CLASS="tema"><IMG SRC="../../librerias/awtema.gif" WIDTH="18" HEIGHT="10" BORDER="0">Historial</TD>
				</TR>
				<TR> 
					<TD BACKGROUND="../../librerias/bgbox.gif"><IMG SRC="../../librerias/pxtransparente.gif" WIDTH="1" HEIGHT="10"></TD>
				</TR>
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde se listan todas las tesis ya realizadas por los ex-alumnos.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$tesis->mostrar($_GET['pagina']);

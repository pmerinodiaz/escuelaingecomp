<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Tesis - Historial - B&uacute;squeda</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="tesis, t�tulos, memorias, b�squedas, buscadores, historiales, motores, recopilaciones, reglamentos, cient�ficos, ofertas, empresas, inform�tica, computaci�n, ingenier�as, alumnos, estudiantes, egresados">
<META NAME="description" CONTENT="P�gina en donde se muestran los resultados de la b�squeda de tesis. Se muestran las tesis que coinciden en el t�tulo de la tesis o con el nombre del autor o el profesor gu�a, en la palabra ingresada por el usuario.">
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde se listan todas las tesis que fueron encontradas
						 * por el buscador de tesis.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$tesis->buscar($_GET['palabra'], $_GET['pagina']);

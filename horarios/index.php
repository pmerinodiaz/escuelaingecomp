<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Horarios</TITLE>
...
<?PHP
/*
 * Script en donde incrementamos el n�mero de visitas del tema 'Horarios'.
*/
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR> 
					<TD WIDTH="76%" CLASS="ubicacion">Ubicaci&oacute;n: <A HREF="../home/index.php" TITLE="Ver Home">Home</A> / Horarios</TD>
					<TD ROWSPAN="2" WIDTH="24%" VALIGN="TOP"><IMG SRC="activos/bghorarios.jpg" WIDTH="110" HEIGHT="45"></TD>
				</TR>
				<TR> 
					<TD WIDTH="76%" CLASS="titulo">Horarios de Clases</TD>
				</TR>
				<TR> 
  ...
  <TR>
    <TD WIDTH="6" HEIGHT="93" VALIGN="TOP"></TD>
    <TD WIDTH="460" HEIGHT="93" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
        <TR> 
          <TD WIDTH="61%" VALIGN="TOP" CLASS="contenido">En esta secci&oacute;n encontrar&aacute;s toda la informaci&oacute;n sobre los horarios de clases del a&ntilde;o acad&eacute;mico. Adem&aacute;s podr&aacute;s descargar a tu computador todos tus horarios de clases.</TD>
          <TD WIDTH="39%" VALIGN="TOP"><IMG SRC="activos/logohorarios.jpg" WIDTH="180" HEIGHT="80"></TD>
        </TR>
      </TABLE>
		</TD>
    <TD WIDTH="6" HEIGHT="93" VALIGN="TOP"></TD>
  ...
  <TR>
    <TD WIDTH="6" HEIGHT="387" VALIGN="TOP"></TD>
    <TD WIDTH="460" HEIGHT="387" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
        <TR> 
          <TD CLASS="contenido"> 
                        <?PHP
						/*
						 * Script para mostrar los horarios para los niveles del a�o actual.
						*/
						
						// Librer�as necesarias.
						include("../librerias/horario.php");
						
						// Creamos un objeto de la clase horario y listamos los horarios.

<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Admisi&oacute;n - Consultas</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="consultas, preguntas, dudas, respuestas, paa, psu, ingreso, postular, puntajes, admisiones, postulaciones, pruebas, requisitos, universidades, serena, uls, carreras, ingenier�as, computaci�n, inform�tica">
<META NAME="description" CONTENT="P�gina en donde se muestran todas las consultas que hemos recibido sobre el tema de la admisi�n a la carrera Ingenier�a en Computaci�n de la ULS y que fueron contestadas satisfactoriamente.">
...
<?PHP
/**
 * Script en donde incrementamos el n�mero de visitas del tema 'Consultas de Admisi�n'.
*/
...
{								
	...
	// Decimos que los par�metros son correctos.
	$correcto = true;
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
            <?PHP
			/**
			 * Script en donde creamos el objeto consulta y mostramos el t�tulo de esta secci�n.
			*/
			
			// Cuando el par�metro es v�lido.
			if ($correcto)
			{
				// Librer�as necesarias.
				...
				$consulta->tituloConsultasAdmision();
			}
			// Cuando el par�metro no es v�lido.
			else
			{
				// Librer�as necesarias.
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/**
						 * Script que muestra en forma paginada las consultas de admisi�n.
						*/
						
						// Cuando el par�metro es v�lido.
						if ($correcto)
						{
							$consulta->mostrar(4, $_GET['pagina']);

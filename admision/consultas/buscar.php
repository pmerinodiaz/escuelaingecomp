<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Admisi&oacute;n - Consultas - B&uacute;squeda</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="consultas, preguntas, dudas, respuestas, b�squedas, buscadores, motores, paa, psu, ingresos, postular, puntajes, admisiones, postulaciones, pruebas, requisitos, universidades, serena, uls, carreras, ingenier�as, computaci�n">
<META NAME="description" CONTENT="P�gina que muestra las consultas y preguntas referentes al tema de admisi�n a la Escuela, obtenidas como resultados de la b�squeda realizada por el usuario en la b�squeda de consultas. Se seleccionan las consultas que coincidan en el t�tulo o la respuesta con la palabra ingresada.">
...
<?PHP
/**
 * Script en donde se verifica que los par�metros recibidos en la URL sean v�lidos.
*/
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			if ($correcto)
			{
				...
				$consulta->tituloBusquedaAdmision();
			}
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde se listan todas las consultas de admisi�n que ha contestado el
						 * Webmaster de la Escuela IC y que son el resultado de la b�squeda ingresada por
						 * el usuario.
						*/
						...
						if ($correcto)
						{
							$consulta->buscar(4, $_GET['palabra'], $_GET['pagina']);

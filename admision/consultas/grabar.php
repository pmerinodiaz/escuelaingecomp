...
<META NAME="keywords" CONTENT="preguntar, consultar, dudar, agregar, paa, psu, ingresos, postulaciones, puntajes, admisiones, pruebas, requisitos, universidades, serena, carreras, ingenier�as, computaci�n">
<META NAME="description" CONTENT="P�gina en la cual se registra la consulta o pregunta de admisi�n enviada por un usuario. Los datos son recibidos del formulario de la p�gina agregar.php.">
...
if (isset($_POST['nombres']) && isset($_POST['paterno']) && isset($_POST['materno']) && isset($_POST['email']) && isset($_POST['asunto']) && isset($_POST['notificacion']) && isset($_POST['texto']) && is_string($_POST['nombres']) && is_string($_POST['paterno']) && is_string($_POST['materno']) && is_string($_POST['email']) && is_string($_POST['asunto']) && is_string($_POST['texto']))
	$correcto = true;
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			...
			*/
			...
			if ($correcto)
			{
				...
				$consulta->tituloAgregarConsulta();
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
			<?PHP
			/*
			 * Script que registra en la base de datos los datos que se pusieron en el formulario de
			 * la p�gina agregar.php y muestra mensajes, dependiendo de como se efectu� la operaci�n.
			*/
			
			// Cuando los par�metros son v�lidos.
			if ($correcto)
			{
				$consulta->agregar(4, "../../", "index.php?pagina=1", $_POST['nombres'], $_POST['paterno'], $_POST['materno'], $_POST['email'], $_POST['asunto'], $_POST['notificacion'], $_POST['texto']);

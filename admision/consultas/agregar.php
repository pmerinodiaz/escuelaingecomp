<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Admisi&oacute;n - Consultas - Agregar</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META NAME="keywords" CONTENT="preguntar, consultar, dudar, agregar, paa, sies, pat, ingresos, postulaciones, puntajes, admisiones, pruebas, requisitos, universidades, serena, uls, carreras, ingenierias, computacion">
<META NAME="description" CONTENT="P�gina que contiene el formulario para que el usuario pueda agregar una nueva consulta sobre el tema de admisi�n a la Escuela Ingenier�a en Computaci�n.">
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    <TD WIDTH="154" HEIGHT="640" ROWSPAN="2" VALIGN="TOP" BACKGROUND="../../librerias/bgmenu.gif">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR> 
					<TD WIDTH="76%" CLASS="ubicacion">Ubicaci&oacute;n: <A HREF="../../home/index.php" TITLE="Ver Home">Home</A> / <A HREF="../index.php" TITLE="Ver Admisi&oacute;n">Admisi&oacute;n</A> / <A HREF="index.php?pagina=1" TITLE="Ver Consultas">Consultas</A> / Agregar</TD>
					<TD ROWSPAN="2" WIDTH="24%" VALIGN="TOP"><IMG SRC="activos/bgconsultas.gif" WIDTH="110" HEIGHT="45"></TD>
				</TR>
				<TR> 
					<TD WIDTH="76%" CLASS="titulo">Agregar consulta sobre la Admisi&oacute;n</TD>
				</TR>
				<TR> 
    ...
    <TD WIDTH="154" HEIGHT="640" ROWSPAN="2" VALIGN="TOP" BACKGROUND="../../librerias/bgmenu.gif">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				...
				<TR> 
					<TD BACKGROUND="../../librerias/bgbox.gif" CLASS="tema"><IMG SRC="../../librerias/awtema.gif" WIDTH="18" HEIGHT="10" BORDER="0">Consultas</TD>
				</TR>
				<TR> 
					<TD BACKGROUND="../../librerias/bgbox.gif"><IMG SRC="../../librerias/pxtransparente.gif" WIDTH="1" HEIGHT="10"></TD>
				</TR>
  ...
  <TR>
    <TD WIDTH="6" HEIGHT="580" VALIGN="TOP"></TD>
    <TD WIDTH="460" HEIGHT="580" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
        <TR> 
          <TD CLASS="contenido">
						<P>A trav&eacute;s de esta opci&oacute;n, podr&aacute;s realizar tus consultas sobre el proceso de admisi&oacute;n a la carrera de Ingenier&iacute;a en Computaci&oacute;n de la <A HREF="http://www.userena.cl" TARGET="_blank" TITLE="Visitar Web de Universidad de La Serena">Universidad de La Serena</A>, lo que constituye un valioso aporte que nos permite mejorar nuestro servicio.</P>
                ...
                <TD>
                    ...
                    <TABLE WIDTH="100%" BORDER="0" CELLPADDING="0">
                      ...
                      <TR> 
                        ...
                        <TD><INPUT NAME="nombres" TYPE="text" CLASS="formtextfield" TABINDEX="1" MAXLENGTH="50" TITLE="Primer y segundo nombre">
                          <SPAN CLASS="contenido"><FONT COLOR="#CC0000">*</FONT></SPAN></TD>
                      </TR>
                      <TR> 
                        <TD CLASS="formlabel">Apellido Paterno:</TD>
                        <TD><INPUT NAME="paterno" TYPE="text" CLASS="formtextfield" TABINDEX="1" MAXLENGTH="25" TITLE="Apellido paterno">
                          <SPAN CLASS="contenido"> <FONT COLOR="#CC0000">*</FONT></SPAN></TD>
                      </TR>
                      <TR> 
                      ...
                      <TR> 
                        <TD COLSPAN="2" ALIGN="CENTER"><TEXTAREA NAME="texto" ROWS="8" TABINDEX="1" CLASS="formtextarea" TITLE="Texto del mensaje"></TEXTAREA>
                          <SPAN CLASS="contenido"> <FONT COLOR="#CC0000">*</FONT></SPAN></TD>
                      </TR>
                      <TR>
                        <TD COLSPAN="2">&nbsp;</TD>

...
<META NAME="keywords" CONTENT="pruebas, bancos, ex�menes, parciales, recuperativas, validaciones, cert�menes, colecciones">
<META NAME="description" CONTENT="En esta p�gina se muestran todas las pruebas que tiene la asignatura elegida por el usuario. Cada prueba tiene un v�nculo para que el usuario pueda descargarla o enlazarse a ella.">
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
            <?PHP
			/*
			 * Script en donde mostramos el t�tulo, el nombre de la asignatura y la
			...
			*/
			...
			if ($correcto)
			{
				...
				// Creamos un objeto prueba y mostramos el t�tulo de esta secci�n.
				$prueba = new prueba($link);
				$prueba->mostrarTitulo($_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP"> 
            <?PHP
			/*
			 * Script en donde mostramos las pruebas de la asignatura.
			*/
			
			// Cuando los par�metros no son v�lidos.
			if ($correcto)
			{
				$prueba->mostrar($_GET['id'], $_GET['pagina']);

<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Software - Estad&iacute;sticas</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="software, nuestros, terceros, estad�sticas, estudiantes, acad�micos, alumnos, desarrolladores, programaci�n, webmaster, programadores, analistas, dise�adores, software, programas, sistemas, c�digos, fuentes, nuestros, estad�sticas, computaci�n, utilidades, recursos, herramientas, utiler�as">
<META NAME="description" CONTENT="P�gina donde se muestran los tres software m�s visitados, los tres software m�s votados y los tres software m�s comentados.">
...
<?PHP
/*
 * Script en donde incremenatamos el n�mero de visitas del tema 'Estad�sticas de Software'.
*/
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR> 
					<TD WIDTH="76%" CLASS="ubicacion">Ubicaci&oacute;n: <A HREF="../../home/index.php" TITLE="Ver Home">Home</A> / <A HREF="../index.php" TITLE="Ver Software">Software</A> / Estad&iacute;sticas</TD>
					<TD ROWSPAN="2" WIDTH="24%" VALIGN="TOP"><IMG SRC="activos/bgestadisticas.jpg" WIDTH="110" HEIGHT="45"></TD>
				</TR>
				<TR> 
					<TD WIDTH="76%" CLASS="titulo">Estad&iacute;sticas de Software</TD>
				</TR>
				<TR> 
    ...
    <TD WIDTH="154" HEIGHT="540" ROWSPAN="2" VALIGN="TOP" BACKGROUND="../../librerias/bgmenu.gif">
          ...
          <TD BACKGROUND="../../librerias/bgbox.gif" CLASS="tema"><A HREF="../terceros/index.php" TITLE="Ver Software de Terceros"><IMG SRC="../../librerias/awtema.gif" WIDTH="18" HEIGHT="10" BORDER="0">De Terceros</A> </TD>
				...
				<TR> 
          <TD BACKGROUND="../../librerias/bgbox.gif" CLASS="tema"><IMG SRC="../../librerias/awtema.gif" WIDTH="18" HEIGHT="10" BORDER="0">Estad&iacute;sticas</TD>
				</TR>
				<TR> 
					<TD BACKGROUND="../../librerias/bgbox.gif"><IMG SRC="../../librerias/pxtransparente.gif" WIDTH="1" HEIGHT="10"></TD>
				</TR>
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde se listan los tres software m�s visitados, los tres software
						 * m�s comentados y los tres software m�s votados.
						*/
						
						// Librer�as necesarias.
						include("../../librerias/software.php");
						include("../../librerias/tiempo.php");
						
						// Creamos un objeto software y mostramos las estad�sticas de los software.
						$software = new software($link);
						$tiempo = new tiempo();
						$software->estadisticas(1, $tiempo);
						$software->estadisticas(2, $tiempo);
						$software->estadisticas(3, $tiempo);

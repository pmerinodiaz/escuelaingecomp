<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Software - Nuestros - Comentar</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="software, nuestros, estudiantes, acad�micos, alumnos, comentar, comentarios, desarrolladores, programaci�n, webmaster, programadores, analistas, dise�adores, programas, sistemas, c�digos, fuentes, terceros, estad�sticas, computaci�n, utilidades, recursos, herramientas, utiler�as">
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			<?PHP
			/*
			 * Script en donde mostramos el t�tulo del apartado donde estamos y la
			 * navegaci�n 'ubicaci�n'.
			*/
			...
			if ($correcto)
			{
				...
				// Creamos el objeto software y mostramos el t�tulo con el nombre del apartado
				// donde estamos.
				$software = new software($link);
				$software->tituloComentar(1, $_POST['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
						<?PHP
						/*
						 * Script que registra en la base de datos los datos que se pusieron en el
						 * formulario de la p�gina comentar.php y muestra mensajes, dependiendo de
						 * como se efectu� la operaci�n.
						*/
						...
						if ($correcto)
						{
							...
							// Creamos el objeto comentario y registramos el comentario.

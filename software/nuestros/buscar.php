<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Software - Nuestros - B&uacute;squeda</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="software, b�squedas, buscadores, motores, nuestros, estudiantes, acad�micos, alumnos, desarrolladores, programaci�n, webmasters, programadores, analistas, dise�adores, programas, sistemas, c�digos, fuentes, terceros, estad�sticas, computaci�n, utilidades, utiler�as, recursos, herramientas">
<META NAME="description" CONTENT="P�gina en la cual se realiza la b�squeda de nuestros software referentes a un sistema operativo, y que coinciden en el t�tulo o descripci�n con la palabra ingresada por el usuario.">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			// Cuando los par�metros son v�ldios.
			if ($correcto)
			{
				...
				$software->tituloBusqueda(1, $_GET['id']);
			}
			// Cuando los par�metros no son v�ldios.
			else
			{
				// Librer�as necesarias.
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde mostramos el listado de software nuestros, ordenados por fecha
						...
						*/
						...
						if ($correcto)
						{
							$software->buscar(1, $_GET['id'], $_GET['palabra'], $_GET['pagina']);

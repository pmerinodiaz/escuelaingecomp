...
<META NAME="description" CONTENT="En esta p�gina se presenta un formulario para que el usuario pueda enviar un comentario a un software nuestro.">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			...
			*/
			...
			if ($correcto)
			{
				...
				$software->tituloComentar(1, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
        ...
        <TR> 
          <TD> 
						...
						*/
						...
						if ($correcto)
						{
							$software->detallar(1, 0, 2, $_GET['id']);

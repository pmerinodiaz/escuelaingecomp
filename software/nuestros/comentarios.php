<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Software - Nuestros - Comentarios</TITLE>
...
<META NAME="description" CONTENT="En esta p�gina se muestran los comentarios enviados desde los usuarios hacia un software.">
...
if (isset($_GET['id']) && isset($_GET['pagina']) && $_GET['id'] != NULL && $_GET['pagina'] != NULL && is_numeric($_GET['id']) && is_string($_GET['pagina']))
	$correcto = true;
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			if ($correcto)
			{
				...
				$software->tituloComentarios(1, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
          ...
          <TD> 
						...
						*/
						...
						if ($correcto)
						{
							...
							// Mostramos el detalle del software elegido y los comentarios realizados.
							$software->detallar(1, 0, 3, $_GET['id']);

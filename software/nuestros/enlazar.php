<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Software - Nuestros - Acceso</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="software, nuestros, estudiantes, acad�micos, alumnos, desarrolladores, programaci�n, webmaster, programadores, analistas, dise�adores, programas, sistemas, c�digos, fuentes, terceros, estad�sticas, computaci�n, utilidades, recursos, herramientas, utiler�as">
<META NAME="description" CONTENT="En esta p�gina podemos descargar el archivo que contiene el software nuestro o bien nos podemos enlazar a la p�gina del sitio de descarga del software nuestro. Tambi�n mostramos los detalles del software descargado.">
...
<?PHP
/*
 * Script que verifica que vengan todos los par�metros en la URL para as� escribir
 * en el TAG body de la p�gina, ya que en este TAG se llama evento onLoad() que abre
 * el sitio web de descarga o bien el archivo.
*/
...
if (isset($_GET['id']) && $_GET['id'] != NULL && is_numeric($_GET['id']))
{
	...
	// Creamos el objeto software y nos enlazamos al URL del software.
	$software = new software($link);
	$url = $software->url($_GET['id']);
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
            <?PHP
			/*
			 * En este script mostramos el t�tulo donde se muestra el nombre del apartado
			 * donde estamos y la navegaci�n 'ubicaci�n'.
			*/
			
			// Cuando los par�metros son v�lidos.
			if ($correcto)
				$software->tituloAcceso(1, $_GET['id']);
			// Cuando los par�metros no son v�lidos.
			else
			{
				// Librer�as necesarias.
        ...
        <TR> 
          <TD> 
						...
						*/
						...
						if ($correcto)
						{
							$software->detallar(1, 1, 1, $_GET['id']);

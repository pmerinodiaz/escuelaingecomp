...
<META NAME="keywords" CONTENT="software, nuestros, estudiantes, acad�micos, alumnos, desarrolladores, programaci�n, webmaster, programadores, analistas, dise�adores, programas, sistemas, c�digos, fuentes, terceros, estad�sticas, computaci�n, utilidades, utiler�as, recursos, herramientas">
<META NAME="description" CONTENT="En esta p�gina en donde se listan todos nuestros software referentes al sistema operativo elegido por el usuario. Tambi�n existe un formulario para que el usuario pueda buscar un software nuestro.">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			if ($correcto)
			{
				...
				$software->mostrarTitulo(1, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde mostramos el listado de software nuestros, ordenados
						...
						*/
						...
						if ($correcto)
						{
							$software->mostrar(1, $_GET['id'], $_GET['pagina']);

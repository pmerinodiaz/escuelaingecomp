<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Software - Nuestros - Votaci&oacute;n</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="software, nuestros, estudiantes, acad�micos, alumnos, votar, votaci�n, calificar, desarrolladores, programaci�n, webmaster, programadores, analistas, dise�adores, programas, sistemas, c�digos, fuentes, terceros, estad�sticas, computaci�n, utilidades, recursos, herramientas, utiler�as">
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
            <?PHP
			/*
			 * Script en donde mostramos el t�tulo del apartado y la navegaci�n 'ubicaci�n'.
			*/
			...
			if ($correcto)
			{
				...
				$software->tituloVotar(1, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
						 ...
						 * y el formulario de votaci�n del software.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$software->detallar(1, 0, 4, $_GET['id']);

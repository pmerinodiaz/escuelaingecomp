...
<META NAME="keywords" CONTENT="software, nuestros, estudiantes, acad�micos, alumnos, votar, votaciones, desarrolladores, programaci�n, webmaster, programadores, analistas, dise�adores, programas, sistemas, c�digos, fuentes, terceros, estad�sticas, computaci�n, utilidades, recursos, herramientas, utiler�as">
<META NAME="description" CONTENT="P�gina en donde se registra la votaci�n efectuada por un usuario a un software.">
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
            <?PHP
			/*
			 * Script en donde mostramos el t�tulo del apartado donde estamos y
			 * la navegaci�n 'ubicaci�n'.
			*/
			...
			if ($correcto)
			{
				...
				$software->tituloVotar(1, $_POST['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{

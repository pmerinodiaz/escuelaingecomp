...
<META NAME="keywords" CONTENT="software, terceros, votar, votaciones, desarrolladores, programaci�n, webmaster, programadores, analistas, dise�adores, programas, sistemas, c�digos, fuentes, nuestros, estad�sticas, computaci�n, utilidades, utiler�as, recursos, herramientas">
<META NAME="description" CONTENT="P�gina en la cual se muestra el formulario de votaci�n para que usuario pueda calificar un software.">
...
function setearFoco()
{
	if(document.formulario!=null)
		document.formulario.votar.focus();
}
//-->
</SCRIPT>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			if ($correcto)
			{
				...
				$software->tituloVotar(2, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
        ...
        <TR> 
          <TD> 
						...
						*/
						...
						if ($correcto)
						{
							$software->detallar(2, 0, 4, $_GET['id']);
							$conexion->desconectar();
							$tipo = "software";
							require("../../librerias/agregavotacion.inc");
						}
						// Cuando los par�metros son v�lidos.
						else $error->mostrar();
						?>

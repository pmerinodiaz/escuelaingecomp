<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Software - De Terceros - Acceso</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="software, terceros, acceso, acceder, downloads, descargar, nuestros, desarrolladores, programaci�n, webmaster, programadores, analistas, dise�adores, programas, sistemas, c�digos, fuentes, estad�sticas, utilidades, utiler�as, recursos, herramientas">
<META NAME="description" CONTENT="En esta p�gina podemos descargar el archivo que contiene el software de terceros o bien nos podemos enlazar a la p�gina del sitio de descarga del software de terceros. Tambi�n mostramos los detalles del software descargado.">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			// Cuando los par�metros son v�lidos.
			if ($correcto)
				$software->tituloAcceso(2, $_GET['id']);
			else
			{
				// Librer�as necesarias.
        ...
        <TR> 
          <TD> 
						...
						*/
						...
						if ($correcto)
						{
							$software->detallar(2, 1, 1, $_GET['id']);

<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Software - De Terceros - Comentar</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="software, terceros, comentar, comentarios, opinar, opiniones, desarrolladores, programaci�n, webmaster, programadores, analistas, dise�adores, software, programas, sistemas, c�digos, fuentes, nuestros, estad�sticas, computaci�n, utilidades, recursos, herramientas">
<META NAME="description" CONTENT="En esta p�gina se registra el comentario enviado por un usuario hacia un software.">
...
<?PHP
/*
 * Script en donde verificamos la existencia de los par�metros del formularios.
*/

// Cuando los par�metros son v�lidos.
if (!isset($_POST['nombres']) || !isset($_POST['paterno']) || !isset($_POST['materno']) || !isset($_POST['email']) || !isset($_POST['texto']) || !isset($_POST['id']) || !is_string($_POST['nombres']) || !is_string($_POST['paterno']) || !is_string($_POST['materno']) || !is_string($_POST['email']) || !is_string($_POST['texto']) || !is_numeric($_POST['id']))
	$correcto = false;
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			<?PHP
			/*
			 * Script mostramos el t�tulo del apartado donde estamos y la navegaci�n 'ubicaci�n'.
			*/
			...
			if ($correcto)
			{
				...
				// Creamos el objeto software y mostramos el t�tulo con el nombre del apartado donde estamos.
				$software = new software($link);
				$software->tituloComentar(2, $_POST['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
				...
				// Creamos un objeto error y mostramos el titulo.
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
						 ...
						 * de la p�gina comentar.php y muestra mensajes, dependiendo de como se efectu� la
						 * operaci�n.
						*/
						...
						{
							// Librer�as necesarias.
							include("../../librerias/comentario.php");
							
							$comentario = new comentario($link);
							$comentario->agregar(1, $_POST['id'], $_POST['nombres'], $_POST['paterno'], $_POST['materno'], $_POST['email'], $_POST['texto']);

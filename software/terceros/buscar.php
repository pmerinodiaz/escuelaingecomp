<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Software - De Terceros - B&uacute;squeda</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="software, terceros, b�squedas, buscadores, motores, desarrolladores, programaci�n, webmaster, programadores, analistas, dise�adores, programas, sistemas, c�digos, fuentes, nuestros, estad�sticas, utilidades, utiler�as, recursos, herramientas">
<META NAME="description" CONTENT="P�gina en la cual se realiza la b�squeda de software de terceros referentes a un sistema operativo, y que coinciden en el t�tulo o descripci�n con la palabra ingresada por el usuario.">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			if ($correcto)
			{
				...
				$software->tituloBusqueda(2, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde mostramos el listado de software de terceros, ordenados por fecha
						 * de recepci�n y que coinciden con la palabra ingresada por el usuario.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$software->buscar(2, $_GET['id'], $_GET['palabra'], $_GET['pagina']);

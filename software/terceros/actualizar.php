<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Software - De Terceros - Votaci&oacute;n</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="software, terceros, votar, votaciones, desarrolladores, programaci�n, webmaster, programadores, analistas, dise�adores, programas, sistemas, c�digos, fuentes, terceros, estad�sticas, computaci�n, utilidades, utiler�as, recursos, herramientas">
<META NAME="description" CONTENT="P�gina en la se registra la votaci�n que el usuario hace a un software.">
...
if (!isset($_POST['nota']) || !isset($_POST['id']) || !is_numeric($_POST['nota']) || !is_numeric($_POST['id']))
	$correcto = false;
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
            <?PHP
			/*
			 * Script en donde mostramos el t�tulo del apartado donde estamos y la navegaci�n 'ubicaci�n'.
			*/
			...
			if ($correcto)
			{
				...
				$software->tituloVotar(2, $_POST['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script que registra en la Base de Datos la votaci�n de un usuario por un software.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$software->votar(1, $_POST['id'], $_POST['nota']);

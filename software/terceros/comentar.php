...
<META NAME="keywords" CONTENT="software, terceros, comentar, comentarios, opinar, desarrolladores, programaci�n, webmaster, programadores, analistas, dise�adores, programas, sistemas, c�digos, fuentes, nuestros, estad�sticas, computaci�n, utilidades, utiler�as, recursos, herramientas">
<META NAME="description" CONTENT="En esta p�gina se presenta un formulario para que el usuario pueda enviar un comentario a un software de terceros.">
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			...
			*/
			...
			if ($correcto)
			{
				...
				$software->tituloComentar(2, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
        ...
        <TR> 
          <TD> 
						...
						*/
						...
						if ($correcto)
						{
							$software->detallar(2, 0, 2, $_GET['id']);
							$conexion->desconectar();
							require("../../librerias/agregacomentario.inc");
						}
						// Cuando los par�metros no son v�lidos.
						else $error->mostrar();
						?>

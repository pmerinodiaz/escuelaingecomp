<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Software - De Terceros - Comentarios</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="software, terceros, comentar, comentarios, opinar, opiniones, desarrolladores, programaci�n, webmaster, programadores, analistas, dise�adores, programas, sistemas, c�digos, fuentes, nuestros, estad�sticas, utilidades, utiler�as, recursos, herramientas">
...
<?PHP
/*
 * Script en donde verificamos la existencia de los par�metros enviados en la URL.
*/
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
			...
			*/
			...
			if ($correcto)
			{
				...
				$software->tituloComentarios(2, $_GET['id']);
			}
			// Cuando los par�metros son v�lidos.
			else
			{
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde mostramos el detalle del software elegido por el usuario
						 * y los comentarios efectuados por un usuario.
						*/
						...
						if ($correcto)
						{
							...
							// Mostramos el detalle del software elegido y los comentarios.
							$software->detallar(2, 0, 3, $_GET['id']);
							$comentario = new comentario($link);
							$comentario->mostrar($_GET['id'], $_GET['pagina']);

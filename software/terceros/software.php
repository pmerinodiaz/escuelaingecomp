...
<META NAME="keywords" CONTENT="software, terceros, desarrolladores, programaci�n, webmaster, programadores, analistas, dise�adores, programas, sistemas, c�digos, fuentes, estad�sticas, computaci�n, utilidades, utiler�as, recursos, herramientas, nuestros">
<META NAME="description" CONTENT="En esta p�gina en donde se listan todos los software creados por terceros, referentes al sistema operativo elegido por el usuario. Tambi�n existe un formulario para que el usuario pueda buscar un software de tercero.">
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP"> 
            <?PHP
			/*
			 * Script en donde creamos el objeto software o bien el objeto error.
			*/
			...
			if ($correcto)
			{
				...
				// Creamos un objeto software y mostramos el t�tulo de esta secci�n.
				$software = new software($link);
				$software->mostrarTitulo(2, $_GET['id']);
			}
			// Cuando los par�metros no son v�lidos.
			else
			{
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP">
        ...
        <TR> 
          <TD> 
                        <?PHP
						/*
						 * Script en donde mostramos el listado de software de terceros, ordenados
						 * por fecha de recepci�n.
						*/
						
						// Cuando los par�metros son v�lidos.
						if ($correcto)
						{
							$software->mostrar(2, $_GET['id'], $_GET['pagina']);

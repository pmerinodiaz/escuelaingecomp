<HTML>
<HEAD>
<TITLE>Escuela Ingenier&iacute;a en Computaci&oacute;n - Software - De Terceros</TITLE>
<META HTTP-EQUIV="content-type" content="text/html; charset=utf-8">
<META HTTP-EQUIV="content-language" CONTENT="Es">
<META HTTP-EQUIV="pragma" CONTENT="no-cache">
<META NAME="keywords" CONTENT="software, utiler�as, �tiles, terceros, desarrolladores, programaci�n, webmaster, programadores, analistas, dise�adores, programas, sistemas, c�digos, fuentes, estad�sticas, computaci�n, utilidades, recursos, herramientas, nuestros">
<META NAME="description" CONTENT="En esta secci�n vamos a ir colocando todo tipo de programas y utilidades encontrados en Internet y que son frecuentemente utilizados en nuestra carrera. Estas herramientas te permitir�n hacer m�s f�cil y accesible tu trabajo como programador o Webmaster.">
...
<?PHP
/*
 * Script en donde incrementamos el n�mero de visitas del tema 'Software de Terceros'.
*/
...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="60" COLSPAN="4" VALIGN="TOP">
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR> 
					<TD WIDTH="76%" CLASS="ubicacion">Ubicaci&oacute;n: <A HREF="../../home/index.php" TITLE="Ver Home">Home</A> / <A HREF="../index.php" TITLE="Ver Software">Software</A> / De Terceros</TD>
					<TD ROWSPAN="2" WIDTH="24%" VALIGN="TOP"><IMG SRC="activos/bgterceros.jpg" WIDTH="110" HEIGHT="45"></TD>
				</TR>
				<TR> 
					<TD WIDTH="76%" CLASS="titulo">Software de Terceros</TD>
				</TR>
				<TR> 
  ...
  <TR>
    ...
    <TD WIDTH="460" HEIGHT="480" COLSPAN="4" VALIGN="TOP"> 
			<TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPACING="0" MM_NOCONVERT="TRUE">
				<TR> 
					<TD WIDTH="25%" HEIGHT="98" ALIGN="CENTER"><IMG SRC="activos/logoterceros.jpg" WIDTH="90" HEIGHT="90"></TD>
					<TD WIDTH="75%" VALIGN="TOP" CLASS="contenido">En esta secci&oacute;n vamos a ir colocando todo tipo de programas y utilidades encontrados en Internet y que son frecuentemente utilizados en nuestra carrera. Estas herramientas te permitir&aacute;n hacer m&aacute;s f&aacute;cil y accesible tu trabajo como programador o Webmaster.</TD>
				</TR>
				<TR> 
					<TD COLSPAN="2">&nbsp;</TD>
				</TR>
				<TR> 
					<TD COLSPAN="2">
						 ...
						 * software de terceros y los �tlimos 3 software de terceros incorporados recientemente.
						*/
						
						// Librer�as necesarias.
						include("../../librerias/software.php");
						
						// Creamos un objeto software, mostramos los sistemas operativos y los software destacados.
						$software = new Software($link);
						$software->sistemasOperativos(2);
						$software->destacados(2);
